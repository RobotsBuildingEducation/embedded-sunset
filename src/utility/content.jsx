...
- \`data_set && data_object\` are also fundamentally equivalent.
  ...
  Stay focused and best of luck with the rest!
    ...
    question: {
      ...
      previewCode: "function SemanticLayoutPreview() {\n  const [section, setSection] = React.useState('Learn');\n  return (\n    <div style={{ fontFamily: 'system-ui, sans-serif', fontSize: 13 }}>\n      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#0f172a', color: 'white', padding: '6px 12px', borderRadius: 8 }}>\n        <strong style={{ color: '#f472b6', fontSize: 13 }}>Build Lab</strong>\n        <nav style={{ display: 'flex', gap: 6 }}>\n          {['Learn', 'Create'].map(s => (\n            <button key={s} onClick={() => setSection(s)} style={{ border: 0, borderRadius: 5, padding: '3px 8px', background: section === s ? '#ec4899' : '#334155', color: 'white', fontSize: 11, cursor: 'pointer', fontWeight: 600 }}>{s}</button>\n          ))}\n        </nav>\n      </header>\n      <main style={{ padding: '8px 4px 4px', textAlign: 'center' }}>\n        <h4 style={{ margin: '0 0 2px', color: '#0f172a', fontSize: 13, fontWeight: 700 }}>{section} with semantic HTML</h4>\n        <p style={{ margin: 0, color: '#64748b', fontSize: 11.5, lineHeight: 1.3 }}>Header, nav, main, and footer communicate their exact purpose.</p>\n      </main>\n      <footer style={{ marginTop: 4, padding: '3px 8px', fontSize: 10.5, color: '#94a3b8', textAlign: 'center', borderTop: '1px solid #f1f5f9' }}>Semantic Web Standard</footer>\n    </div>\n  );\n}",
      pairs: [{
        left: "<header>",
    ...
    question: {
      ...
      previewCode: "function AccessibleButtonPreview() {\n  const [saved, setSaved] = React.useState(0);\n  return (\n    <div style={{ padding: '8px 4px', fontFamily: 'system-ui, sans-serif', textAlign: 'center' }}>\n      <button type=\"button\" onClick={() => setSaved(c => c + 1)} style={{ background: '#ec4899', color: 'white', border: 0, padding: '7px 16px', borderRadius: 8, cursor: 'pointer', fontWeight: 700, fontSize: 13, boxShadow: '0 2px 8px rgba(236,72,153,.25)' }}>Save changes</button>\n      <p aria-live=\"polite\" style={{ margin: '6px 0 0', color: '#475569', fontSize: 11.5 }}>{saved ? `Saved ${saved} ${saved === 1 ? 'time' : 'times'}` : 'Interactive button with keyboard focus and ARIA'}</p>\n    </div>\n  );\n}",
    ...
    question: {
      ...
      previewCode: "function ProductCardPreview() {\n  const [added, setAdded] = React.useState(false);\n  return (\n    <article style={{ padding: 10, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, fontFamily: 'system-ui, sans-serif', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>\n      <div>\n        <span style={{ fontSize: 10, color: '#ec4899', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Starter project</span>\n        <h3 style={{ margin: '1px 0', fontSize: 14, color: '#0f172a' }}>Portfolio Card</h3>\n        <p style={{ margin: 0, color: '#64748b', fontSize: 11.5 }}>Semantic & accessible card component</p>\n      </div>\n      <button onClick={() => setAdded(!added)} style={{ border: 0, borderRadius: 7, padding: '7px 12px', cursor: 'pointer', background: added ? '#10b981' : '#ec4899', color: 'white', fontWeight: 700, fontSize: 12, flexShrink: 0 }}>{added ? 'Added \u2713' : 'Add to app'}</button>\n    </article>\n  );\n}",
    ...
    question: {
      ...
      previewCode: "function FlexNavbarPreview() {\n  const [active, setActive] = React.useState('Docs');\n  return (\n    <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 8, background: '#0f172a', color: 'white', fontFamily: 'system-ui, sans-serif' }}>\n      <strong style={{ color: '#f472b6', fontSize: 13 }}>Sunset</strong>\n      <div style={{ display: 'flex', gap: 5 }}>\n        {['Docs', 'Projects', 'Profile'].map((item) => (\n          <button key={item} onClick={() => setActive(item)} style={{ border: 0, borderRadius: 5, padding: '4px 7px', cursor: 'pointer', background: active === item ? '#ec4899' : '#334155', color: 'white', fontSize: 11, fontWeight: 600 }}>{item}</button>\n        ))}\n      </div>\n    </nav>\n  );\n}",
...
Stay focused and good luck with the rest!
    ...
    question: {
      ...
      previewCode: "function SemanticLayoutPreview() {\n  const [seccion, setSeccion] = React.useState('Aprender');\n  return (\n    <div style={{ fontFamily: 'system-ui, sans-serif', fontSize: 13 }}>\n      <header style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: '#0f172a', color: 'white', padding: '6px 12px', borderRadius: 8 }}>\n        <strong style={{ color: '#f472b6', fontSize: 13 }}>Build Lab</strong>\n        <nav style={{ display: 'flex', gap: 6 }}>\n          {['Aprender', 'Crear'].map(s => (\n            <button key={s} onClick={() => setSeccion(s)} style={{ border: 0, borderRadius: 5, padding: '3px 8px', background: seccion === s ? '#ec4899' : '#334155', color: 'white', fontSize: 11, cursor: 'pointer', fontWeight: 600 }}>{s}</button>\n          ))}\n        </nav>\n      </header>\n      <main style={{ padding: '8px 4px 4px', textAlign: 'center' }}>\n        <h4 style={{ margin: '0 0 2px', color: '#0f172a', fontSize: 13, fontWeight: 700 }}>{seccion} con HTML sem\xE1ntico</h4>\n        <p style={{ margin: 0, color: '#64748b', fontSize: 11.5, lineHeight: 1.3 }}>Header, nav, main y footer comunican su prop\xF3sito exacto.</p>\n      </main>\n      <footer style={{ marginTop: 4, padding: '3px 8px', fontSize: 10.5, color: '#94a3b8', textAlign: 'center', borderTop: '1px solid #f1f5f9' }}>Est\xE1ndar Web Sem\xE1ntico</footer>\n    </div>\n  );\n}",
      pairs: [{
        left: "<header>",
    ...
    question: {
      ...
      previewCode: "function AccessibleButtonPreview() {\n  const [guardado, setGuardado] = React.useState(0);\n  return (\n    <div style={{ padding: '8px 4px', fontFamily: 'system-ui, sans-serif', textAlign: 'center' }}>\n      <button type=\"button\" onClick={() => setGuardado(c => c + 1)} style={{ background: '#ec4899', color: 'white', border: 0, padding: '7px 16px', borderRadius: 8, cursor: 'pointer', fontWeight: 700, fontSize: 13, boxShadow: '0 2px 8px rgba(236,72,153,.25)' }}>Guardar cambios</button>\n      <p aria-live=\"polite\" style={{ margin: '6px 0 0', color: '#475569', fontSize: 11.5 }}>{guardado ? `Guardado ${guardado} ${guardado === 1 ? 'vez' : 'veces'}` : 'Bot\xF3n interactivo accesible con teclado y ARIA'}</p>\n    </div>\n  );\n}",
      options: ['<button\n  type="button"\n  onClick={handleClick}\n>\n  Enviar\n</button>', "<div onClick={handleClick}>\n  Enviar\n</div>", "<span onClick={handleClick}>\n  Enviar\n</span>", '<a\n  href="#"\n  onClick={handleClick}\n>\n  Enviar\n</a>'],
      answer: '<button\n  type="button"\n  onClick={handleClick}\n>\n  Enviar\n</button>'
    }
  }, {
    ...
    question: {
      ...
      previewCode: "function ProductCardPreview() {\n  const [agregado, setAgregado] = React.useState(false);\n  return (\n    <article style={{ padding: 10, background: '#f8fafc', border: '1px solid #e2e8f0', borderRadius: 10, fontFamily: 'system-ui, sans-serif', display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10 }}>\n      <div>\n        <span style={{ fontSize: 10, color: '#ec4899', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '0.5px' }}>Proyecto inicial</span>\n        <h3 style={{ margin: '1px 0', fontSize: 14, color: '#0f172a' }}>Tarjeta de Portafolio</h3>\n        <p style={{ margin: 0, color: '#64748b', fontSize: 11.5 }}>Componente de tarjeta sem\xE1ntica y accesible</p>\n      </div>\n      <button onClick={() => setAgregado(!agregado)} style={{ border: 0, borderRadius: 7, padding: '7px 12px', cursor: 'pointer', background: agregado ? '#10b981' : '#ec4899', color: 'white', fontWeight: 700, fontSize: 12, flexShrink: 0 }}>{agregado ? 'Agregado \u2713' : 'Agregar'}</button>\n    </article>\n  );\n}",
    ...
    question: {
      ...
      previewCode: "function FlexNavbarPreview() {\n  const [activo, setActivo] = React.useState('Docs');\n  return (\n    <nav style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 10, padding: '8px 12px', borderRadius: 8, background: '#0f172a', color: 'white', fontFamily: 'system-ui, sans-serif' }}>\n      <strong style={{ color: '#f472b6', fontSize: 13 }}>Sunset</strong>\n      <div style={{ display: 'flex', gap: 5 }}>\n        {['Docs', 'Proyectos', 'Perfil'].map((item) => (\n          <button key={item} onClick={() => setActivo(item)} style={{ border: 0, borderRadius: 5, padding: '4px 7px', cursor: 'pointer', background: activo === item ? '#ec4899' : '#334155', color: 'white', fontSize: 11, fontWeight: 600 }}>{item}</button>\n        ))}\n      </div>\n    </nav>\n  );\n}",
      lines: [".navbar {", "  display: flex;", "  justify-content: space-between;", "  align-items: center;", "  padding: 12px 24px;", "}"],
      answer: [".navbar {", "  display: flex;", "  justify-content: space-between;", "  align-items: center;", "  padding: 12px 24px;", "}"]
    }
  }, {
