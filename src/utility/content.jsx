  ...
  en: [
    {
      ...
      question: {
        questionText:
          "Read about the fundamentals of software in the study guide before starting.",
        metaData: `### Advice
  ...
  Stay focused and best of luck with the rest!
    ...
    },
    {
      ...
      question: {
        ...
        choices: [
          "A value a function receives",
          "The result a function sends back",
          "An instruction that runs a function",
        ],
        answer: {
    ...
    },
    {
      ...
      title: "Select Order",
      description:
        "Practice arranging visible program steps in execution order.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the statements so the program creates a value, updates it, and then displays the result.",
    ...
    },
    {
      ...
      question: {
        questionText:
          "Choose and name a small app idea. We will help it grow as you progress!",
        range: [1, 16],
      },
    },
    {
      ...
      description:
        "Match JavaScript literal values to their corresponding primitive data types.",
      isMatchPairs: true,
      question: {
        questionText:
          "Match each literal value to its correct primitive data type in JavaScript:",
        pairs: [
          {
            left: '"Hello World"',
            right: "string",
    ...
    },
    {
      ...
      question: {
        questionText:
          "Which code snippet correctly defines the function header to accept a name argument?",
    ...
    },
    {
      ...
      description:
        "Understand the critical difference between return values and console.log.",
      isMultipleChoice: true,
      question: {
        questionText:
          "What is the primary difference between returning a value from a function and calling console.log()?",
        options: [
          "return sends data back to the caller for code to use, whereas console.log only displays a value for observation.",
          "console.log sends its displayed value back to the caller, whereas return only shows it in developer tools.",
          "return ends the entire JavaScript program, whereas console.log continues it.",
          "Both make the value available to later calculations in exactly the same way.",
        ],
        answer:
          "return sends data back to the caller for code to use, whereas console.log only displays a value for observation.",
      },
    },
    {
      ...
      description:
        "Refactor a classic function declaration into a concise ES6 arrow function.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the classic add function below into a one-line arrow function:",
        starterCode: "function add(a, b) {\n  return a + b;\n}",
        answer: "const add = (a, b) => a + b;",
        tests: [
          "Returns 7 when passed (3, 4)",
          "Uses concise arrow function syntax",
        ],
      },
    },
    {
      ...
      description:
        "Match comparison and logical operators to their operational behavior.",
      isMatchPairs: true,
      question: {
    ...
    },
    {
      ...
      description:
        "Arrange lines to create a clean cascading grade calculation conditional structure.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the lines into a structured if / else if / else conditional chain:",
        lines: [
          "if (score >= 90) {",
          '  return "A";',
          "} else if (score >= 80) {",
    ...
    },
    {
      ...
      description:
        "Correct the condition so that age 18 is included as an adult.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the condition below so that users aged 18 or older are permitted:",
        starterCode:
    ...
    },
    {
      ...
      description:
        "Identify all values that evaluate to false when cast to a boolean in JavaScript.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Select all values that are inherently 'falsy' in JavaScript:",
        options: [
          "0",
          '""',
          "null",
    ...
    },
    {
      ...
      description:
        "Complete the guard clause comparison to halt invalid execution.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Complete the guard clause condition to return early if the payment amount is less than or equal to zero:",
        template:
    ...
    },
    {
      ...
      description:
        "Discover built-in shell assistance in a Bash terminal environment.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
    ...
    },
    {
      ...
      description:
        "Identify the control flow keyword used to exit loops early.",
      isSingleLineText: true,
      question: {
        questionText:
          "Which keyword is used in JavaScript to immediately terminate and exit a loop before its test condition evaluates to false?",
        answer: "break",
      },
    },
    {
      ...
      description:
        "Order the lifecycle stages of a standard for loop during execution.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the execution steps from for-loop setup through the end of its first successful iteration:",
        options: [
          "1. Initialize counter variable once",
          "2. Evaluate loop condition",
          "3. Execute loop body code block",
          "4. Increment counter expression",
        ],
        answer: [
          "1. Initialize counter variable once",
          "2. Evaluate loop condition",
    ...
    },
    {
      ...
      description:
        "Write a function that iterates through an array to compute its total sum.",
      isCode: true,
      question: {
        questionText:
          "Write a function sumNumbers(numbers) that iterates through an array of numbers and returns their total sum:",
        starterCode:
          "function sumNumbers(numbers) {\n  // Start with a total, visit each number, and return the result.\n}",
        answer:
          "function sumNumbers(numbers) {\n  let total = 0;\n  for (let n of numbers) {\n    total += n;\n  }\n  return total;\n}",
        tests: [
          "sumNumbers returns a number",
          "sumNumbers([1, 2, 3, 4]) returns 10",
        ],
      },
    },
    {
      ...
      description:
        "Select the cleanest and most idiomatic way to calculate the sum of numbers in JavaScript.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which implementation provides the cleanest, most declarative approach to sum an array of numbers?",
        options: [
    ...
    },
    {
      ...
      question: {
        questionText:
          "What will be printed to the console after executing this loop?",
        code: "let count = 1;\nfor (let i = 0; i < 3; i++) {\n  count *= 2;\n}\nconsole.log(count);",
        options: ["8", "6", "4", "16"],
        answer: "8",
      },
    },
    {
      ...
      question: {
        questionText:
          "Fix the loop counter update so it reaches the loop termination condition without freezing:",
        starterCode:
    ...
    },
    {
      ...
      description:
        "Modernize string concatenation with backticks and interpolation.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the string concatenation below to use an ES6 template literal with backticks:",
        starterCode:
          'function createGreeting(name, role) {\n  return "User " + name + " is a " + role + ".";\n}',
        answer:
          "function createGreeting(name, role) {\n  return `User ${name} is a ${role}.`;\n}",
        tests: [
          'Returns "User Alex is a Developer."',
    ...
    },
    {
      ...
      question: {
        questionText:
          "Select the line where the first element of the array is removed:",
    ...
    },
    {
      ...
      description:
        "Practice creating a project folder in a command-line environment.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
    ...
    },
    {
      ...
      description:
        "Explain the architectural trade-offs between indexed and iterable loops.",
      isText: true,
      question: {
        questionText:
          "Explain the difference between iterating over an array with an indexed for loop versus a for...of loop. When is an indexed loop required over for...of?",
      },
    },
    {
      group: "1",
      ...
      isConversationReview: true,
      description:
        "See your app gain its first logic with variables, functions, conditions, loops, and arrays.",
      question: {
        questionText:
          "Your app can now make decisions and work with collections. Let's add that progress to your idea!",
        range: [19, 38],
      },
    },
    {
      ...
      description:
        "Match object syntax concepts to their definitions and access methods.",
      isMatchPairs: true,
      question: {
        questionText:
          "Match each JavaScript object concept to its description:",
        pairs: [
          {
            left: "Object Key",
        ...
        choices: [
          "The named identifier for a property in an object",
          "The data stored at a specific property key",
          "Dot notation for direct property access",
          "Bracket notation for dynamic or string-keyed access",
        ],
        answer: {
    ...
    },
    {
      ...
      description:
        "Write a function that constructs and returns a structured user object.",
      isCode: true,
      question: {
        questionText:
          "Write a function createUser(name, role) that returns an object containing name, role, and an isActive property set to true:",
        starterCode:
          "function createUser(name, role) {\n  // Return an object with name, role, and isActive.\n}",
        answer:
          "function createUser(name, role) {\n  return {\n    name,\n    role,\n    isActive: true\n  };\n}",
        tests: [
          "createUser returns an object",
          "createUser('Alice', 'admin').isActive is true",
        ],
      },
    },
    {
      ...
      description:
        "Refactor verbose dot-notation property reads into clean object destructuring.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the manual property assignments into a single destructuring assignment:",
        starterCode:
        ...
        tests: [
          "Returns 'Laptop: $999'",
          "Uses object destructuring { title, price }",
        ],
      },
    },
    {
      ...
      description:
        "Clone and update object properties without mutating the original object.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Complete the object spread syntax to create a copy of original with an updated dark theme:",
        template:
          'const original = { id: 1, theme: "light" };\nconst updated = { {{...original}}, theme: {{"dark"}} };',
        blanks: [
          {
            key: "...original",
    ...
    },
    {
      ...
      description:
        "Correct the constructor property assignment to bind values to this.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the User class constructor below so that the name and email arguments are saved to the instance:",
        starterCode:
          "class User {\n  constructor(name, email) {\n    name = name;\n    email = email;\n  }\n}",
        answer:
          "class User {\n  constructor(name, email) {\n    this.name = name;\n    this.email = email;\n  }\n}",
        tests: [
          "new User('Sam', 's@dev.io').name equals 'Sam'",
          "Uses this.name and this.email",
        ],
      },
    },
    {
      ...
      description:
        "Understand the lifecycle of creating an object instance from a class blueprint.",
      isMultipleChoice: true,
      question: {
        questionText:
          "What happens when you execute const student = new User('Maya', 'maya@dev.io')?",
        options: [
          "A new object is created in memory, its constructor is executed with 'this' bound to the new instance, and the instance is returned.",
          "The User class definition is deleted and replaced with a plain function.",
          "The code compiles the class into a static JSON string on disk.",
          "It invokes the class without setting any internal instance properties.",
        ],
        answer:
          "A new object is created in memory, its constructor is executed with 'this' bound to the new instance, and the instance is returned.",
      },
    },
    {
      ...
      description:
        "Arrange the chronological phases of defining and using class instances.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the phases of defining and using a class instance in chronological execution order:",
        options: [
          "Define class blueprint with constructor and methods",
          "Instantiate object using new ClassName(args)",
          "Constructor initializes instance properties on this",
          "Invoke instance method (e.g. user.getDetails())",
        ],
        answer: [
          "Define class blueprint with constructor and methods",
          "Instantiate object using new ClassName(args)",
    ...
    },
    {
      ...
      description:
        "Identify the line where this becomes undefined due to losing method binding.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line where detaching the method from the instance causes 'this' context to be lost:",
    ...
    },
    {
      ...
      description:
        "Choose the cleanest way to extract an array of active usernames.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which method chain cleanest filters active users and maps their names?",
        options: [
          "const names = users\n  .filter((u) => u.isActive)\n  .map((u) => u.name);",
    ...
    },
    {
      ...
      description:
        "Identify the array method used to filter elements by a predicate callback.",
      isSingleLineText: true,
      question: {
        questionText:
          "Which built-in JavaScript Array method returns a new array containing all elements that satisfy a given predicate function?",
        answer: "filter",
      },
    },
    {
      ...
      question: {
        questionText:
          "Select all true statements regarding JavaScript objects and references:",
        options: [
          "Object variables hold a memory reference to the object, not the object data itself",
          "Mutating a nested property on a cloned object affects both if a shallow copy was made",
          "const prevents the variable identifier from being reassigned, but object properties can still be modified",
          "Objects can only store string values, never functions or arrays",
          "Object keys must be integer numbers starting at index 0",
        ],
        answer: [
          "Object variables hold a memory reference to the object, not the object data itself",
          "Mutating a nested property on a cloned object affects both if a shallow copy was made",
    ...
    },
    {
      ...
      description:
        "Trace variable references pointing to the same underlying object in memory.",
      isCodeTracing: true,
      question: {
        questionText:
          "What will be printed for userA.score after running this code?",
    ...
    },
    {
      ...
      description:
        "Organize class extension and parent constructor invocation.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the lines to create an Employee class that inherits from Person:",
        lines: [
    ...
    },
    {
      ...
      description:
        "Explain why avoiding direct object mutation is critical in modern applications.",
      isText: true,
      question: {
        questionText:
          "Why is immutability important when modifying objects or arrays in JavaScript applications? Explain what unexpected side effects direct mutation causes.",
      },
    },
    {
      group: "2",
      ...
      description:
        "Select the operator that safely reads deeply nested properties without crashing.",
      isCodeCompletion: true,
      question: {
        questionText:
          "Which operator safely accesses deeply nested properties when an intermediate property might be null or undefined?",
    ...
    },
    {
      ...
      description:
        "Trace class instantiation and method execution to compute internal instance state.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predict the final logged count value after calling increment(3):",
    ...
    },
    {
      ...
      question: {
        questionText:
          "In a Bash terminal environment, enter the echo command to print 'Data ready'",
      },
    },
    {
      group: "2",
      ...
      isConversationReview: true,
      description:
        "See your app gain a structured data model with objects, classes, and collection methods.",
      question: {
        questionText:
          "Your app now has structured data. Let's connect objects and collections to your idea!",
        range: [40, 56],
      },
    },
    {
      ...
      description:
        "Match semantic HTML elements to their appropriate layout and content roles.",
      isMatchPairs: true,
      question: {
        ...
        choices: [
          ...
          "The dominant, unique content of the document body",
          "A standalone thematic grouping of related content",
          "Closing information, copyright notices, or author links",
        ],
        answer: {
          "<header>":
            "Introductory content, site title, or top-level navigation",
    ...
    },
    {
      ...
      description:
        "Complete an input element with the correct type and placeholder.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Complete the input tag to accept email addresses with a helpful placeholder:",
        template:
    ...
    },
    {
      ...
      description:
        "Select the accessible element for triggering interactive actions.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which implementation provides native keyboard accessibility and screen reader support for a button?",
        options: [
          '<button\n  type="button"\n  onClick={handleClick}\n>\n  Submit\n</button>',
    ...
    },
    {
      ...
      description:
        "Add meaningful alternative text so an HTML image is accessible.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the HTML image so a screen reader can communicate what it represents:",
        starterCode: '<img src="profile.jpg">',
        answer: '<img src="profile.jpg" alt="User profile">',
        tests: [
          "Includes a meaningful alt attribute",
          "Keeps the original image source",
        ],
      },
    },
    {
      ...
      description:
        "Fill in the missing semantic HTML tags to complete an interactive product card.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Fill in the missing semantic HTML elements to complete the product card:",
        template:
    ...
    },
    {
      ...
      description:
        "Order the concentric layers of the CSS Box Model from innermost to outermost.",
      isSelectOrder: true,
      question: {
        questionText: "Arrange the CSS Box Model layers from the inside out:",
        options: [
          "1. Content area (text/image dimensions)",
    ...
    },
    {
      ...
      question: {
        questionText:
          "Match each CSS layout property to its effect on the element:",
        pairs: [
          {
        ...
        choices: [
          "Includes padding and border inside declared width",
          "Horizontally centers a block element with defined width",
          "Sets spacing between flex/grid child elements",
          "Clips child content that exceeds container boundary",
        ],
        answer: {
    ...
    },
    {
      ...
      description:
        "Identify the CSS math function used for responsive fluid typography and sizing.",
      isSingleLineText: true,
      question: {
        questionText:
          "Which CSS math function accepts a minimum, preferred, and maximum value to enable fluid responsive sizing without media queries?",
        answer: "clamp()",
      },
    },
    {
      ...
      description:
        "Select all valid techniques for preventing unwanted horizontal page scrolling.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Which techniques help prevent unexpected horizontal overflow and page scrollbars on mobile viewports?",
        options: [
          "Use box-sizing: border-box globally across all elements",
          "Use max-width: 100% on images and media containers",
          "Avoid fixed wide pixel widths on layout wrappers (use percentages, flex, or rem)",
          "Set min-width: 2000px on all container elements",
        ],
        answer: [
          "Use box-sizing: border-box globally across all elements",
          "Use max-width: 100% on images and media containers",
    ...
    },
    {
      ...
      description:
        "Arrange CSS flexbox properties to space out a navigation bar with centered items.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the CSS flexbox rules to create a space-between horizontal navbar:",
        lines: [
          ".navbar {",
          "  display: flex;",
    ...
    },
    {
      ...
      description:
        "Write a React functional component rendering a controlled text input.",
      isCode: true,
      question: {
        questionText:
          "Write a React component SearchInput({ query, setQuery }) that binds value and onChange to control an HTML input:",
        starterCode:
        ...
        tests: [
          ...
          "Binds value to query and updates via onChange",
        ],
      },
    },
    {
      ...
      description:
        "Complete the array filter to match search queries case-insensitively.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Complete the filter expression to search products by title:",
        template:
    ...
    },
    {
      ...
      description:
        "Refactor unmanaged DOM input reads to controlled React useState binding.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the imperative document.getElementById read into a controlled React input with useState:",
        starterCode:
          "function Form() {\n  const handleSubmit = () => {\n    const text = document.getElementById('name').value;\n    alert(text);\n  };\n  return <input id='name' />;\n}",
        answer:
          "function Form() {\n  const [name, setName] = useState('');\n  const handleSubmit = () => { alert(name); };\n  return <input value={name} onChange={e => setName(e.target.value)} />;\n}",
        tests: [
          "Uses useState('') for name",
          "Binds value and onChange to input",
        ],
      },
    },
    {
      ...
      description:
        "Write a helper function that immutably updates a form field in state.",
      isCode: true,
      question: {
        questionText:
          "Write a function updateField(formData, fieldName, value) that returns a new object with the specified field updated immutably:",
        starterCode:
          "function updateField(formData, fieldName, value) {\n  // Return a new object with the requested field updated.\n}",
        answer:
          "function updateField(formData, fieldName, value) {\n  return {\n    ...formData,\n    [fieldName]: value\n  };\n}",
        tests: [
          "Returns a new object without mutating original",
          "Updates the dynamic field key correctly",
        ],
      },
    },
    {
      ...
      description:
        "Locate the line that clears the text input back to an empty string.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line that resets the input field state to an empty string after saving:",
    ...
    },
    {
      ...
      description:
        "Render alternative components based on a boolean authentication flag.",
      isCodeCompletion: true,
      question: {
        questionText:
          "Which JSX expression renders Dashboard when isLoggedIn is true and LoginView otherwise?",
        options: [
          "{\n  isLoggedIn ? (\n    <Dashboard />\n  ) : (\n    <LoginView />\n  )\n}",
          "{\n  if (isLoggedIn) (\n    <Dashboard />\n  ) else (\n    <LoginView />\n  )\n}",
          "{\n  isLoggedIn && (\n    <Dashboard />\n  ) || (\n    <LoginView />\n  )\n}",
    ...
    },
    {
      ...
      description:
        "Select all mandatory syntax rules when writing JSX in React.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Select all valid syntax rules required when writing JSX:",
        options: [
          "Every tag must be explicitly closed (e.g. <img /> or <br />)",
          "Components must return a single root element or Fragment (<>...</>)",
          "Use camelCase attributes like className and htmlFor instead of class and for",
          "JavaScript expressions inside JSX must be enclosed in curly braces {}",
          "HTML class names must always be written in all-caps",
        ],
        answer: [
          "Every tag must be explicitly closed (e.g. <img /> or <br />)",
          "Components must return a single root element or Fragment (<>...</>)",
    ...
    },
    {
      ...
      description:
        "Arrange lines to handle loading, error, and content branches in order.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the conditional return hierarchy for an asynchronous view:",
        lines: [
    ...
    },
    {
      ...
      description:
        "Predict which element renders when the items list is empty.",
      isCodeTracing: true,
      question: {
    ...
    },
    {
      ...
      question: {
        questionText:
          "Which React tab implementation cleanly renders views based on active tab state?",
        options: [
    ...
    },
    {
      ...
      description:
        "Begin the React phase by connecting JavaScript functions, props, and rendered JSX.",
      isMultipleChoice: true,
      question: {
        questionText:
          "What is a functional React component in modern web development?",
        options: [
          "A JavaScript function that accepts props and returns JSX describing what should appear on screen.",
          "A custom hook that can only return state values and never JSX.",
          "An event handler that directly replaces the page DOM whenever state changes.",
          "A JavaScript class used only to store data and never render an interface.",
        ],
        answer:
          "A JavaScript function that accepts props and returns JSX describing what should appear on screen.",
      },
    },
    {
      ...
      description:
        "Explain how React optimizes rendering using the Virtual DOM.",
      isText: true,
      question: {
        questionText:
          "Explain how React's Virtual DOM and reconciliation algorithm optimize updates to the real browser DOM. Why is this more efficient than direct DOM manipulation?",
      },
    },
    {
      group: "3",
      ...
      question: {
        questionText:
          "In a production build without a StrictMode wrapper, how many total times will 'Render App' log if the button is clicked twice?",
        code: "function App() {\n  const [count, setCount] = React.useState(0);\n  console.log('Render App');\n  return (\n    <button onClick={() => setCount((c) => c + 1)}>\n      Click {count}\n    </button>\n  );\n}",
        options: [
          "3 times (1 initial mount render + 2 click re-renders)",
          "2 times (only clicks re-render)",
          "1 time (components render once)",
          "0 times (functions don't run console logs)",
        ],
    ...
    },
    {
      ...
      description:
        "Fix the click handler to update count immutably using the state setter function.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the increment handler below so it calls setCount instead of mutating count directly:",
        starterCode:
          "function Counter() {\n  let [count, setCount] = useState(0);\n  const handleIncrement = () => {\n    count = count + 1;\n  };\n  return <button onClick={handleIncrement}>{count}</button>;\n}",
        answer:
          "function Counter() {\n  const [count, setCount] = useState(0);\n  const handleIncrement = () => {\n    setCount(c => c + 1);\n  };\n  return <button onClick={handleIncrement}>{count}</button>;\n}",
        tests: [
          "Uses setCount(c => c + 1) or setCount(count + 1)",
          "Triggers component re-render on click",
        ],
      },
    },
    {
      ...
      description:
        "Understand how React wraps native browser events in cross-browser SyntheticEvents.",
      isMultipleChoice: true,
      question: {
        questionText:
          "Why does React wrap native browser DOM events in SyntheticEvents?",
        options: [
          "To provide consistent event behavior and properties across all web browsers.",
          "To prevent any keyboard events from firing in the browser.",
          "To automatically send every click event to a remote database.",
          "To convert all mouse clicks into right-click events.",
        ],
        answer:
          "To provide consistent event behavior and properties across all web browsers.",
      },
    },
    {
      ...
      description:
        "Identify the primary hook used for state management in functional components.",
      isSingleLineText: true,
      question: {
        questionText:
          "What is the name of the standard React hook used to declare and update local state variables in functional components?",
        answer: "useState",
      },
    },
    {
      ...
      description:
        "Explain the difference between props and state in component architecture.",
      isText: true,
      question: {
        questionText:
          "Explain the fundamental differences between props and state in React. How does data flow between parent and child components?",
      },
    },
    {
      group: "3",
      ...
      question: {
        questionText:
          "Select the line where the mapped element is missing a unique key prop:",
    ...
    },
    {
      ...
      description:
        "Trace data flowing from a parent state into a child presentation component.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predict what text will display in the Child badge after clicking increment once:",
    ...
    },
    {
      ...
      question: {
        questionText:
          "In a Bash terminal environment, enter the command to list files in the current directory",
      },
    },
    {
      group: "3",
      ...
      question: {
        questionText:
          "Match each styling technique to its implementation style:",
        pairs: [
          {
          ...
          },
          {
            left: "CSS Modules",
            right:
              'import styles from "./Button.module.css"; className={styles.btn}',
          },
          {
        ...
        choices: [
          ...
          'className="custom-button" with global style sheet',
        ],
        answer: {
          "Inline Style Object":
            'style={{ backgroundColor: "#3b82f6", padding: 12 }}',
    ...
    },
    {
      ...
      description:
        "Order the CSS rules to structure a centered column card container.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the CSS rules to center card content vertically and horizontally in a column:",
        options: [
          "1. display: flex;",
    ...
    },
    {
      ...
      description:
        "Lift state from child into parent so multiple sibling components share state.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the isolated state inside SearchInput up into the parent SearchPage:",
        starterCode:
          "function SearchPage() {\n  return (\n    <div>\n      <SearchInput />\n      <SearchResults />\n    </div>\n  );\n}\n\nfunction SearchInput() {\n  const [query, setQuery] = useState('');\n  return (\n    <input\n      value={query}\n      onChange={(e) => setQuery(e.target.value)}\n    />\n  );\n}",
        answer:
          "function SearchPage() {\n  const [query, setQuery] = useState('');\n  return (\n    <div>\n      <SearchInput\n        query={query}\n        setQuery={setQuery}\n      />\n      <SearchResults query={query} />\n    </div>\n  );\n}\n\nfunction SearchInput({ query, setQuery }) {\n  return (\n    <input\n      value={query}\n      onChange={(e) => setQuery(e.target.value)}\n    />\n  );\n}",
        tests: [
          "Defines const [query, setQuery] in SearchPage",
          "Passes query to SearchResults",
        ],
      },
    },
    {
      ...
      description:
        "Explain what constitutes a side effect and why useEffect is required.",
      isText: true,
      question: {
        questionText:
          "What is a side effect in React, and why should operations like data fetching, event subscriptions, and DOM timers be placed inside useEffect?",
      },
    },
    {
      group: "3",
      ...
      description:
        "Order the chronological phases of a component from initial mount to unmount.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the chronological phases of a React component's lifecycle:",
        options: [
          "1. Initial component render (Mount)",
          "2. Execute useEffect setup functions",
          "3. State or prop update triggers re-render",
          "4. Component unmounts and executes useEffect cleanup",
        ],
        answer: [
          "1. Initial component render (Mount)",
          "2. Execute useEffect setup functions",
    ...
    },
    {
      ...
      description:
        "Order the stages of fetching data and managing loading/error states in an effect.",
      isSelectOrder: true,
      question: {
        questionText: "Arrange the steps to fetch data safely in useEffect:",
        options: [
          "1. Set loading state to true",
          "2. Execute await fetch(endpoint)",
          "3. Parse response JSON and set data state",
          "4. Catch potential errors and set loading to false",
        ],
        answer: [
          "1. Set loading state to true",
          "2. Execute await fetch(endpoint)",
    ...
    },
    {
      ...
      description:
        "Select the clean React state update that appends a new item immutably.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which state setter implementation correctly appends a new post to the top of the feed?",
        options: [
          "setPosts((prev) => [\n  newPost,\n  ...prev\n]);",
    ...
    },
    {
      ...
      description:
        "Choose the reliable state update form when the next value depends on the previous one.",
      isMultipleChoice: true,
      question: {
        questionText:
          "Why is setCount((current) => current + 1) safer than setCount(count + 1) when several updates may be queued?",
        options: [
          "React gives each updater the latest queued state, avoiding calculations from a stale render value.",
          "The updater directly mutates count without rendering.",
          "React state setters only accept functions, never values.",
          "The updater prevents the component from rendering again.",
        ],
        answer:
          "React gives each updater the latest queued state, avoiding calculations from a stale render value.",
      },
    },
    {
      ...
      description:
        "Extract reusable fetch state logic into a useFetch custom hook.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Extract the data fetching logic into a reusable useFetch custom hook:",
        starterCode:
    ...
    },
    {
      ...
      description:
        "Fill in the missing dependency array to prevent infinite re-render loops.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Fill in the empty dependency array to ensure the fetch effect runs only once when the component mounts:",
        template: "useEffect(() => {\n  fetchData();\n}, {{[]}});",
        blanks: [
          {
            key: "[]",
    ...
    },
    {
      ...
      description:
        "Select all valid criteria and reasons for using key props in React.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Select all true statements about key props in React list rendering:",
        options: [
          "Keys allow React to identify which items have changed, added, or removed",
          "Keys should be unique and stable identifiers (e.g. item.id) rather than array indices",
          "Using Math.random() as a key forces unnecessary remounting of elements on every render",
          "Keys are automatically passed into child components as regular props accessible via props.key",
          "Key props are only required if the list has more than 1000 items",
        ],
        answer: [
          "Keys allow React to identify which items have changed, added, or removed",
          "Keys should be unique and stable identifiers (e.g. item.id) rather than array indices",
    ...
    },
    {
      ...
      description:
        "Arrange lines to pass a callback from parent to child to update parent state.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the lines of a parent component managing a child item toggle:",
        lines: [
          "function TodoApp() {",
          "  const [todos, setTodos] = useState([]);",
          "  const toggle = (id) => {",
          "    setTodos(t => update(t, id));",
          "  };",
          "  return <TodoList items={todos} onToggle={toggle} />;",
          "}",
        ],
        answer: [
          "function TodoApp() {",
    ...
    },
    {
      ...
      description:
        "Locate the missing dependency array that triggers an infinite render cycle.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line where the missing dependency array causes the effect to run on every re-render:",
    ...
    },
    {
      ...
      description:
        "Identify the required naming prefix for React custom hooks.",
      isSingleLineText: true,
      question: {
        questionText:
          "What two-letter prefix must every custom React hook name start with by convention (e.g. useWindowSize)?",
        answer: "use",
      },
    },
    {
      ...
      description:
        "Trace computed values derived directly during render without extra setState calls.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predict what will be printed for activeCount during render:",
    ...
    },
    {
      ...
      description:
        "Wrap arbitrary JSX components inside a reusable Modal layout.",
      isCodeCompletion: true,
      question: {
        questionText:
          "Which component wrapper cleanly renders arbitrary child content inside a modal container?",
        options: [
    ...
    },
    {
      ...
      description:
        "Use AbortController to stop an in-flight request during effect cleanup.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the effect so its fetch request is aborted if the component unmounts before the response arrives:",
        starterCode:
        ...
        tests: [
          ...
          "Passes controller.signal to fetch",
          "Calls controller.abort during cleanup",
        ],
      },
    },
    {
      ...
      description:
        "Write a utility that filters active users and maps their names.",
      isCode: true,
      question: {
        questionText:
          "Write a function getActiveUserNames(users) that filters users where isActive is true and returns an array of their name strings:",
        starterCode:
    ...
    },
    {
      ...
      description:
        "Understand how returning a cleanup function from useEffect clears active timers and prevents memory leaks.",
      showPreview: true,
      isCodeCompletion: true,
      question: {
        questionText:
          "Which useEffect implementation correctly starts an interval timer and clears it in the cleanup function?",
        previewCode:
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "See your app evolve from semantic HTML and responsive CSS into an interactive React interface.",
      question: {
        questionText:
          "Your app now has a responsive, interactive interface. Let's celebrate what changed!",
        range: [58, 106],
      },
    },
    {
      ...
      description:
        "Match core HTTP verbs to standard CRUD database operations.",
      isMatchPairs: true,
      question: {
        ...
        choices: [
          "Retrieve data or read resources from the server",
          "Create a new resource with a request payload",
    ...
    },
    {
      ...
      description:
        "Identify the standard HTTP status code for missing resources.",
      isSingleLineText: true,
      question: {
        questionText:
          "What standard 3-digit HTTP status code indicates that the requested server endpoint or resource could not be found?",
        answer: "404",
      },
    },
    {
      ...
      description:
        "Understand non-blocking I/O and how promises resolve in JavaScript.",
      isMultipleChoice: true,
      question: {
        questionText:
          "Why does Node.js use non-blocking asynchronous I/O for network and database operations?",
        options: [
          "It lets JavaScript continue handling work while the runtime waits for I/O and later queues the callback or promise continuation.",
          "It makes every database operation finish at the same time and in any order.",
          "It guarantees that network requests cannot fail or time out.",
          "It moves every JavaScript function into its own operating-system process.",
        ],
        answer:
          "It lets JavaScript continue handling work while the runtime waits for I/O and later queues the callback or promise continuation.",
      },
    },
    {
      ...
      description:
        "Arrange lines to asynchronously fetch and parse JSON data from an endpoint.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the lines into a complete async data fetching function:",
        lines: [
    ...
    },
    {
      ...
      description:
        "Write an Express GET route returning a status JSON response.",
      isCode: true,
      question: {
        questionText:
          "Write a function registerHealthRoute(app) that registers a GET route on '/api/health' returning a status 200 JSON object { status: 'healthy' }:",
        starterCode:
        ...
        tests: [
          ...
          "Responds with 200 status and healthy JSON",
        ],
      },
    },
    {
      ...
      description:
        "Extract incoming body data and return a 201 Created response.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Complete the POST handler to parse req.body and respond with status 201:",
        template:
    ...
    },
    {
      ...
      description:
        "Add missing await to prevent sending unresolved promises in API response.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the async handler below so it awaits the database query before sending JSON response:",
        starterCode:
          "app.get('/api/users', async (req, res) => {\n  const users = db.getUsers();\n  res.json(users);\n});",
        answer:
          "app.get('/api/users', async (req, res) => {\n  const users = await db.getUsers();\n  res.json(users);\n});",
        tests: [
          "Awaits db.getUsers() before sending response",
          "Sends resolved user records",
        ],
      },
    },
    {
      ...
      description:
        "Refactor deeply nested error-first callbacks into clean async/await.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the callback-based query into a modern async/await function:",
        starterCode:
        ...
        tests: [
          ...
          "Returns resolved user object directly",
        ],
      },
    },
    {
      ...
      description:
        "Compare relational tables and document stores for modern applications.",
      isText: true,
      question: {
        questionText:
          "Compare relational (SQL) databases with document (NoSQL) databases like Firestore. In what scenarios is a flexible NoSQL schema preferable over a strict SQL schema?",
      },
    },
    {
      group: "4",
      ...
      description:
        "Select the parameterized query implementation that prevents SQL injection.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which database query implementation safely uses parameterized inputs to prevent SQL injection attacks?",
        options: [
    ...
    },
    {
      ...
      description:
        "Order the standard lifecycle steps of token-based API authentication.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the chronological steps in a token-based authentication flow:",
        options: [
          ...
          "4. Client sends token in Authorization Bearer header for API requests",
        ],
        answer: [
          "1. Client sends login credentials to /auth/login",
          "2. Server validates credentials and signs a JWT",
    ...
    },
    {
      ...
      description:
        "Identify how parent-child records are linked in a relational model.",
      isCodeCompletion: true,
      question: {
        questionText:
          "Which schema definition correctly links a 'comments' table to an author in the 'users' table?",
        options: [
    ...
    },
    {
      ...
      description:
        "Correct the HTTP status code sent when a requested resource is not found.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the status code below so that a missing user returns 404 instead of 200:",
        starterCode:
          "app.get('/api/users/:id', async (req, res) => {\n  const user = await db.find(req.params.id);\n  if (!user) {\n    return res.status(200).json({\n      error: 'User not found'\n    });\n  }\n  res.json(user);\n});",
        answer:
          "app.get('/api/users/:id', async (req, res) => {\n  const user = await db.find(req.params.id);\n  if (!user) {\n    return res.status(404).json({\n      error: 'User not found'\n    });\n  }\n  res.json(user);\n});",
        tests: [
          "Returns status 404 when user is null",
          "Returns error message payload",
        ],
      },
    },
    {
      ...
      description:
        "Fill in the environment variable reference for JWT secret signing.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Fill in the process.env reference to load the secret key dynamically without hardcoding:",
        template:
    ...
    },
    {
      ...
      description:
        "Select the most robust Express authentication guard middleware.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which middleware correctly validates Bearer tokens from authorization headers?",
        options: [
    ...
    },
    {
      ...
      description:
        "Arrange lines to configure Express middleware and protected route handlers.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the lines to configure JSON parsing middleware before the API route:",
        lines: [
          "const app = express();",
    ...
    },
    {
      ...
      description:
        "Select all critical security measures for production API servers.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Select all essential security best practices for backend API servers:",
        options: [
          "Sanitize and validate all incoming user input",
          "Implement rate limiting to prevent brute-force attacks",
          "Store passwords using salted cryptographic hashes (e.g. bcrypt)",
          "Use HTTPS / TLS to encrypt all traffic in transit",
          "Expose database credentials directly in client-side bundles",
          "Disable CORS checks for all domains with wildcard *",
        ],
        answer: [
          "Sanitize and validate all incoming user input",
          "Implement rate limiting to prevent brute-force attacks",
    ...
    },
    {
      ...
      description:
        "Identify the line where error handling catches rejected promises.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line where the catch block intercepts database errors to prevent server crashes:",
    ...
    },
    {
      ...
      description:
        "Trace asynchronous microtasks vs synchronous logs in Node.js.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predict the exact order of console logs printed when running this program:",
    ...
    },
    {
      ...
      description:
        "Execute a command to test a backend endpoint from the terminal.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "In a Bash terminal, use curl to perform a GET request to 'https://api.example.com/health'",
      },
    },
    {
      group: "4",
      ...
      description:
        "Locate the line that grants a specific frontend origin permission through CORS.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line where CORS origin permission is configured:",
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "See your app gain backend routes, persistent data, error handling, and authentication.",
      question: {
        questionText:
          "Your app can now communicate with a backend and protect data. Let's add that progress to your project!",
        range: [108, 128],
      },
    },
    {
      ...
      description:
        "Compare managed backend platforms with infrastructure you provision yourself.",
      isMultipleChoice: true,
      question: {
        questionText:
          "Which trade-off most accurately distinguishes a managed platform such as Firebase or Supabase from running your own VPS?",
        options: [
          "The provider handles much of the provisioning, scaling, and patching, while your app accepts more platform-specific constraints and pricing.",
          "Your team receives full operating-system control but must configure capacity and security patches manually.",
          "The platform can host static files but cannot provide authentication or database services.",
          "The platform is guaranteed to cost less than a VPS at every traffic level.",
        ],
        answer:
          "The provider handles much of the provisioning, scaling, and patching, while your app accepts more platform-specific constraints and pricing.",
      },
    },
    {
      ...
      description:
        "Write a helper function to safely extract configuration from process.env.",
      isCode: true,
      question: {
        questionText:
          "Write a function getDatabaseConfig() that extracts DB_HOST and DB_PORT from process.env with default fallbacks ('localhost' and 5432):",
        starterCode:
          "function getDatabaseConfig() {\n  // Read DB_HOST and DB_PORT and provide both fallbacks.\n}",
        answer:
          "function getDatabaseConfig() {\n  return {\n    host: process.env.DB_HOST || 'localhost',\n    port: Number(process.env.DB_PORT) || 5432\n  };\n}",
        tests: [
          "Returns host and port keys",
          "Applies default fallbacks when env vars are missing",
        ],
      },
    },
    {
      ...
      description:
        "Identify the Git command used to commit staged files to history.",
      isSingleLineText: true,
      question: {
        questionText:
          "Which Git command is used to record staged file snapshots to repository history with an inline commit message (e.g. using the -m flag)?",
        answer: "git commit",
      },
    },
    {
      ...
      description:
        "Arrange lines to create a clean commit and sync it with GitHub.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Arrange the chronological Git workflow commands to stage, commit, and push:",
        lines: [
          "git status",
          "git add .",
          'git commit -m "feat: add real-time message stream"',
    ...
    },
    {
      ...
      description:
        "Clone a remote repository to your local computer in the terminal.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "In a Bash terminal environment, enter the command to clone https://github.com/example/web-app.git",
      },
    },
    {
      group: "5",
      ...
      description:
        "Correct the Firebase config object so that the projectId property is passed correctly.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the Firebase initialization config below so that projectId is included:",
        starterCode:
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  authDomain: 'app.firebaseapp.com'\n};\nconst app = initializeApp(firebaseConfig);",
        answer:
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  authDomain: 'app.firebaseapp.com',\n  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID\n};\nconst app = initializeApp(firebaseConfig);",
        tests: [
          "Includes projectId from import.meta.env",
          "Passes valid Vite client configuration to initializeApp",
        ],
      },
    },
    {
      ...
      description:
        "Refactor legacy v8 namespaced Firebase calls into tree-shakeable modular functions.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the legacy firebase.auth().signInWithPopup(provider) call to the modular v9 syntax:",
        starterCode:
          "function login(provider) {\n  return firebase.auth().signInWithPopup(provider);\n}",
        answer:
          "function login(provider) {\n  return signInWithPopup(auth, provider);\n}",
        tests: [
          "Uses signInWithPopup(auth, provider)",
          "Removes legacy namespaced syntax",
        ],
      },
    },
    {
      ...
      description:
        "Keep client state in sync with login/logout status across page reloads.",
      isFillCodeBlanks: true,
      question: {
    ...
    },
    {
      ...
      description:
        "Select the implementation that properly subscribes to real-time updates and unmounts cleanly.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which React useEffect pattern subscribes to Firestore real-time snapshots and cleans up on unmount?",
        options: [
    ...
    },
    {
      ...
      description:
        "Enforce that users can only read and write their own documents.",
      isCodeCompletion: true,
      question: {
        questionText:
          "Which Firestore security rule ensures that authenticated users can only read and write their own profile document?",
        options: [
    ...
    },
    {
      ...
      description:
        "Explain why server secrets must never be embedded in client-side bundles.",
      isText: true,
      question: {
        questionText:
          "Why is it dangerous to embed private API keys, database credentials, or secret signing tokens inside client-side frontend code or environment variables?",
      },
    },
    {
      group: "5",
      ...
      description:
        "Read public Firebase client configuration correctly in a Vite application.",
      isBestImplementation: true,
      question: {
        questionText:
          "Which snippet correctly reads public Firebase client configuration in Vite, where VITE_* values are bundled and visible to users?",
        options: [
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID\n};",
    ...
    },
    {
      ...
      description:
        "Identify the line where a popup error is logged when the user closes the login window.",
      isRelevantLine: true,
      question: {
        questionText:
          "Select the line where the catch block intercepts user popup cancellation:",
    ...
    },
    {
      ...
      description:
        "Match Git branch management commands with their specific development actions.",
      isMatchPairs: true,
      question: {
        questionText:
          "Match each Git branch workflow command to its exact operation:",
        pairs: [
          {
        ...
        answer: {
          ...
          "git merge feature":
            "Combines feature branch commits into the current branch",
          "git branch -d feature":
            "Deletes a local branch that is already merged",
    ...
    },
    {
      ...
      description:
        "Return the unsubscribe callback from useEffect to stop listening on unmount.",
      isFixBug: true,
      question: {
        questionText:
          "Fix the useEffect hook below so it cleans up the auth state listener when the component unmounts:",
        starterCode:
          "useEffect(() => {\n  const unsubscribe = onAuthStateChanged(auth, setUser);\n}, []);",
        answer:
          "useEffect(() => {\n  const unsubscribe = onAuthStateChanged(auth, setUser);\n  return () => unsubscribe();\n}, []);",
        tests: [
          "Returns cleanup function () => unsubscribe()",
    ...
    },
    {
      ...
      question: {
        questionText:
          "In a Bash terminal, enter the command to start your local project dev server using npm",
      },
    },
    {
      group: "5",
      ...
      description:
        "Order the standard automated stages of Continuous Integration and Deployment.",
      isSelectOrder: true,
      question: {
        questionText:
          "Arrange the chronological order of automated CI/CD pipeline steps:",
        options: [
          "1. Developer pushes commit to GitHub",
          "2. CI pipeline runs automated test suite",
          "3. Build tool compiles optimized production bundle",
          "4. CD pipeline deploys artifacts to global CDN hosting edge",
        ],
        answer: [
          "1. Developer pushes commit to GitHub",
          "2. CI pipeline runs automated test suite",
    ...
    },
    {
      ...
      description:
        "Extract inline database operations into an isolated reusable service function.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactor the inline Firestore write into an isolated addPost service function:",
        starterCode:
          "function handleSave(text) {\n  addDoc(\n    collection(db, 'posts'),\n    { text, date: Date.now() }\n  );\n}",
        answer:
          "export const addPost = (text) => {\n  return addDoc(\n    collection(db, 'posts'),\n    { text, date: Date.now() }\n  );\n};",
        tests: [
          "Exports standalone addPost function",
          "Returns promise from addDoc",
        ],
      },
    },
    {
      ...
      description:
        "Select key operational metrics to monitor after deploying a web app.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Select all vital metrics and tools used to monitor live web applications:",
        options: [
          "Real-time client-side JavaScript error tracking (e.g. Sentry)",
          "API latency and response time percentiles (p95 / p99)",
          "Core Web Vitals and Largest Contentful Paint (LCP)",
          "Database read/write quotas and query execution times",
          "Physical temperature of the user's laptop screen",
        ],
        answer: [
          "Real-time client-side JavaScript error tracking (e.g. Sentry)",
          "API latency and response time percentiles (p95 / p99)",
    ...
    },
    {
      ...
      description:
        "Trace client authentication checking before querying protected documents.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predict the authorization result after checking authentication, verification, and document ownership:",
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "Celebrate how your app grew from an idea into a connected, release-ready full-stack project.",
      question: {
        questionText:
          "Your project has reached its release-ready milestone. Let's celebrate the full journey!",
        range: [130, 149],
      },
    },
  ],
  es: [
    {
      ...
      isStudyGuide: true,
      description:
        "Familiarízate con los fundamentos para mejorar la calidad de tu aprendizaje antes de avanzar.",
      question: {
        questionText:
          "Lee sobre los fundamentos del software en la guía de estudio antes de comenzar.",
        metaData: `### Consejos
...
Stay focused and good luck with the rest!
    ...
    },
    {
      ...
      question: {
        questionText:
          "¿Qué palabras clave pueden declarar una variable de JavaScript?",
        options: ["let", "const", "style", "return"],
        answer: ["let", "const"],
      },
    },
    {
      ...
      question: {
        ...
        choices: [
          "Valor que recibe una función",
          "Resultado que devuelve una función",
          "Instrucción que ejecuta una función",
        ],
        answer: {
    ...
    },
    {
      ...
      title: "Ordenar Pasos",
      description:
        "Practica cómo ordenar pasos visibles según su orden de ejecución.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena las instrucciones para que el programa cree un valor, lo actualice y después muestre el resultado.",
        options: ["let total = 1;", "total += 2;", "console.log(total);"],
        answer: ["let total = 1;", "total += 2;", "console.log(total);"],
      },
    },
    ...
    },
    {
      ...
      question: {
        questionText:
          "Sigue la ejecución del código y determina su resultado final.",
        code: "let count = 1;\ncount += 2;\nconsole.log(count);",
        options: ["1", "2", "3", "undefined"],
        answer: "3",
      },
    ...
    },
    {
      ...
      question: {
        questionText:
          "Corrige el error sin cambiar el comportamiento esperado.",
        starterCode: "const score = 1;\nscore += 1;",
        answer: "let score = 1;\nscore += 1;",
    ...
    },
    {
      ...
      question: {
        questionText:
          "Elige y nombra una pequeña idea de aplicación. ¡La ayudaremos a crecer mientras avanzas!",
        range: [1, 16],
      },
    },
    {
      ...
      description:
        "Relaciona los valores literales de JavaScript con sus tipos de datos primitivos.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada valor literal con su tipo de dato primitivo correcto en JavaScript:",
        pairs: [
          {
            left: '"Hola Mundo"',
            right: "string",
    ...
    },
    {
      ...
      description:
        "Selecciona la sintaxis correcta para declarar una funci\xF3n con par\xE1metros.",
      isCodeCompletion: true,
      question: {
        questionText:
          "\xBFQu\xE9 fragmento de c\xF3digo define correctamente el encabezado de la funci\xF3n para recibir el par\xE1metro nombre?",
    ...
    },
    {
      ...
      description:
        "Comprende la diferencia fundamental entre los valores de retorno y console.log.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Cuál es la diferencia principal entre retornar un valor desde una función y llamar a console.log()?",
        options: [
          "return devuelve datos al invocador para usarlos en el código, mientras console.log solo muestra un valor para observarlo.",
          "console.log devuelve el valor mostrado al invocador, mientras return solo lo enseña en las herramientas de desarrollo.",
          "return termina todo el programa de JavaScript, mientras console.log permite continuarlo.",
          "Ambos dejan el valor disponible para cálculos posteriores exactamente de la misma manera.",
        ],
        answer:
          "return devuelve datos al invocador para usarlos en el código, mientras console.log solo muestra un valor para observarlo.",
      },
    },
    {
      ...
      description:
        "Refactoriza una declaración de función clásica a una función flecha concisa de ES6.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la función clásica sumar a una función flecha concisa en una sola línea:",
        starterCode: "function sumar(a, b) {\n  return a + b;\n}",
        answer: "const sumar = (a, b) => a + b;",
        tests: [
          "Devuelve 7 al pasar (3, 4)",
          "Utiliza la sintaxis concisa de función flecha",
        ],
      },
    },
    {
      ...
      description:
        "Relaciona los operadores de comparación y lógicos con su comportamiento.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada operador con su función de comparación lógica:",
        pairs: [
          {
            left: "===",
    ...
    },
    {
      ...
      description:
        "Ordena las líneas para crear una estructura condicional en cascada para calcular calificaciones.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las líneas en una cadena condicional estructurada if / else if / else:",
        lines: [
          "if (puntaje >= 90) {",
          '  return "A";',
          "} else if (puntaje >= 80) {",
    ...
    },
    {
      ...
      description:
        "Corrige la condición para que los 18 años se incluyan como mayor de edad.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige la condición abajo para permitir el acceso a usuarios de 18 años o más:",
        starterCode:
          "function puedeIngresar(edad) {\n  if (edad > 18) {\n    return true;\n  }\n  return false;\n}",
        answer:
          "function puedeIngresar(edad) {\n  if (edad >= 18) {\n    return true;\n  }\n  return false;\n}",
        tests: [
          "puedeIngresar(18) devuelve true",
          "puedeIngresar(17) devuelve false",
        ],
      },
    },
    {
      ...
      description:
        "Identifica todos los valores que se evalúan como falsos al convertirse a booleano en JavaScript.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todos los valores que son inherentemente 'falsy' (falsos) en JavaScript:",
        options: [
          "0",
          '""',
          "null",
    ...
    },
    {
      ...
      description:
        "Completa la condici\xF3n de la cl\xE1usula de guarda para detener entradas inv\xE1lidas.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa la cl\xE1usula de guarda para retornar temprano si el monto es menor o igual a cero:",
        template:
    ...
    },
    {
      ...
      description:
        "Descubre la ayuda integrada en un entorno de terminal Bash.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "En un entorno de terminal Bash, ingresa el comando help para descubrir comandos básicos.",
      },
    },
    {
      group: "1",
      ...
      description:
        "Identifica la palabra clave de control de flujo para salir temprano de ciclos.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFQu\xE9 palabra clave se usa en JavaScript para terminar y salir inmediatamente de un ciclo antes de que su condici\xF3n sea falsa?",
        answer: "break",
      },
    },
    {
      ...
      description:
        "Ordena las fases del ciclo de vida de un bucle for durante la ejecución.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena los pasos desde la configuración del bucle for hasta el final de su primera iteración válida:",
        options: [
          "1. Inicializar la variable contador una sola vez",
          "2. Evaluar la condición del bucle",
          "3. Ejecutar el bloque de código del cuerpo",
          "4. Incrementar la expresión del contador",
        ],
        answer: [
          "1. Inicializar la variable contador una sola vez",
          "2. Evaluar la condición del bucle",
    ...
    },
    {
      ...
      description:
        "Escribe una funci\xF3n que recorra un arreglo para calcular su suma total.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n sumarNumeros(numeros) que recorra un arreglo de n\xFAmeros y devuelva la suma total:",
        starterCode:
          "function sumarNumeros(numeros) {\n  // Inicia un total, recorre cada número y devuelve el resultado.\n}",
        answer:
          "function sumarNumeros(numeros) {\n  let total = 0;\n  for (let n of numeros) {\n    total += n;\n  }\n  return total;\n}",
        tests: [
          "sumarNumeros devuelve un n\xFAmero",
          "sumarNumeros([1, 2, 3, 4]) es igual a 10",
        ],
      },
    },
    {
      ...
      description:
        "Selecciona la forma más limpia y declarativa de sumar números en JavaScript.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué implementación proporciona el enfoque más limpio y declarativo para sumar un arreglo de números?",
        options: [
          "const sumar = (arr) => arr.reduce((total, n) => total + n, 0);",
          "function sumar(arr) {\n  let total = 0;\n  for (let i = 0; i < arr.length; i++) {\n    total = total + arr[i];\n  }\n  return total;\n}",
    ...
    },
    {
      ...
      description:
        "Rastrea el valor de la variable a través de las iteraciones.",
      isCodeTracing: true,
      question: {
        questionText:
          "¿Qué valor se imprimirá en la consola tras ejecutar este bucle?",
        code: "let conteo = 1;\nfor (let i = 0; i < 3; i++) {\n  conteo *= 2;\n}\nconsole.log(conteo);",
        options: ["8", "6", "4", "16"],
        answer: "8",
      },
    },
    {
      ...
      description:
        "Corrige el avance del contador para que el bucle termine adecuadamente.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige la actualización del contador para que el bucle while no se congele indefinidamente:",
        starterCode:
    ...
    },
    {
      ...
      description:
        "Moderniza la unión de cadenas con comillas invertidas e interpolación.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la concatenación abajo para usar una plantilla literal de ES6 con comillas invertidas:",
        starterCode:
          'function crearSaludo(nombre, rol) {\n  return "Usuario " + nombre + " es un " + rol + ".";\n}',
        answer:
          "function crearSaludo(nombre, rol) {\n  return `Usuario ${nombre} es un ${rol}.`;\n}",
        tests: [
          'Devuelve "Usuario Alex es un Desarrollador."',
          "Utiliza comillas invertidas de plantilla literal",
        ],
      },
    },
    {
      ...
      question: {
        questionText:
          "Selecciona la línea donde se elimina el primer elemento del arreglo:",
    ...
    },
    {
      ...
      description:
        "Practica la creación de una carpeta de proyecto en un entorno de línea de comandos.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
    ...
    },
    {
      ...
      description:
        "Explica las diferencias arquitect\xF3nicas entre ciclos con \xEDndice e iterables.",
      isText: true,
      question: {
        questionText:
          "Explica la diferencia entre iterar un arreglo usando un ciclo for tradicional con \xEDndice vs un ciclo for...of. \xBFCu\xE1ndo se necesita el ciclo con \xEDndice?",
      },
    },
    {
      group: "1",
      ...
      isConversationReview: true,
      description:
        "Observa cómo tu app obtiene su primera lógica con variables, funciones, condiciones, bucles y arreglos.",
      question: {
        questionText:
          "Tu app ya puede tomar decisiones y trabajar con colecciones. ¡Agreguemos ese progreso a tu idea!",
        range: [19, 38],
      },
    },
    {
      ...
      description:
        "Relaciona los conceptos de objetos con sus definiciones y formas de acceso.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada concepto de objetos en JavaScript con su descripción:",
        pairs: [
          {
            left: "Clave del Objeto",
            right:
              "El identificador con nombre para una propiedad en un objeto",
          },
          {
        ...
        choices: [
          "El identificador con nombre para una propiedad en un objeto",
          "Los datos almacenados en una clave de propiedad específica",
          "Notación de punto para acceso directo a propiedades",
          "Notación de corchetes para acceso dinámico o con cadenas",
        ],
        answer: {
          "Clave del Objeto":
            "El identificador con nombre para una propiedad en un objeto",
    ...
    },
    {
      ...
      description:
        "Escribe una funci\xF3n que construya y devuelva un objeto de usuario.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n crearUsuario(nombre, rol) que devuelva un objeto con nombre, rol y la propiedad isActive en true:",
        starterCode:
          "function crearUsuario(nombre, rol) {\n  // Devuelve un objeto con nombre, rol e isActive.\n}",
        answer:
          "function crearUsuario(nombre, rol) {\n  return {\n    nombre,\n    rol,\n    isActive: true\n  };\n}",
        tests: [
          "crearUsuario devuelve un objeto",
          "crearUsuario('Ana', 'admin').isActive es true",
        ],
      },
    },
    {
      ...
      description:
        "Refactoriza lecturas con notación de punto a desestructuración limpia de objetos.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza las asignaciones manuales en una sola instrucción de desestructuración:",
        starterCode:
        ...
        tests: [
          "Devuelve 'Laptop: $999'",
          "Utiliza la desestructuración de objetos { titulo, precio }",
        ],
      },
    },
    {
      ...
      description:
        "Clona y actualiza propiedades sin mutar el objeto original.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa la sintaxis spread para crear una copia de original con tema oscuro actualizado:",
        template:
          'const original = { id: 1, tema: "claro" };\nconst actualizado = { {{...original}}, tema: {{"oscuro"}} };',
        blanks: [
          {
            key: "...original",
    ...
    },
    {
      ...
      description:
        "Corrige la asignación en el constructor para vincular los valores a this.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el constructor de la clase Usuario para que los argumentos nombre y correo se guarden en la instancia:",
        starterCode:
          "class Usuario {\n  constructor(nombre, correo) {\n    nombre = nombre;\n    correo = correo;\n  }\n}",
        answer:
          "class Usuario {\n  constructor(nombre, correo) {\n    this.nombre = nombre;\n    this.correo = correo;\n  }\n}",
        tests: [
          "new Usuario('Sam', 's@dev.io').nombre es igual a 'Sam'",
          "Utiliza this.nombre y this.correo",
        ],
      },
    },
    {
      ...
      description:
        "Comprende el ciclo de vida de crear una instancia a partir de una clase.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Qué sucede al ejecutar const estudiante = new Usuario('Maya', 'maya@dev.io')?",
        options: [
          "Se crea un nuevo objeto en memoria, se ejecuta su constructor con 'this' vinculado a la instancia y se devuelve el objeto.",
          "La clase Usuario se elimina y se reemplaza por una función básica.",
          "El código compila la clase a una cadena JSON estática en disco.",
          "Se invoca la clase sin asignar propiedades internas.",
        ],
        answer:
          "Se crea un nuevo objeto en memoria, se ejecuta su constructor con 'this' vinculado a la instancia y se devuelve el objeto.",
      },
    },
    {
      ...
      description:
        "Ordena las fases cronol\xF3gicas para definir y usar instancias de clases.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena las fases para definir y usar una instancia de clase en orden cronol\xF3gico de ejecuci\xF3n:",
        options: [
          "Definir el modelo de la clase con constructor y m\xE9todos",
          "Instanciar el objeto usando new NombreClase(args)",
          "El constructor inicializa las propiedades en this",
          "Invocar el m\xE9todo de la instancia (ej. usuario.obtenerDetalles())",
        ],
        answer: [
          "Definir el modelo de la clase con constructor y m\xE9todos",
          "Instanciar el objeto usando new NombreClase(args)",
    ...
    },
    {
      ...
      description:
        "Identifica la línea donde this se convierte en undefined al desacoplar el método.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde desacoplar el método de la instancia provoca la pérdida del contexto 'this':",
    ...
    },
    {
      ...
      description:
        "Elige la forma más limpia de filtrar usuarios activos y extraer sus nombres.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué encadenamiento de métodos filtra más limpiamente los usuarios activos y extrae sus nombres?",
        options: [
          ...
          "const nombres = usuarios.reduce((acc, u) => {\n  return u.estaActivo ? [...acc, u.nombre]\n    :\n    acc;\n}, []);",
        ],
        answer:
          "const nombres = usuarios\n  .filter((u) => u.estaActivo)\n  .map((u) => u.nombre);",
      },
    },
    {
      ...
      description:
        "Identifica el m\xE9todo de arreglos para filtrar elementos con un predicado.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFQu\xE9 m\xE9todo nativo de arreglos en JavaScript devuelve un nuevo arreglo con todos los elementos que cumplen con una funci\xF3n de prueba?",
        answer: "filter",
      },
    },
    {
      ...
      description:
        "Selecciona todas las características verdaderas de los objetos en JavaScript.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todas las afirmaciones verdaderas sobre objetos y referencias en JavaScript:",
        options: [
          "Las variables de objetos guardan una referencia de memoria hacia el objeto, no los datos en sí",
          "Modificar una propiedad anidada en un objeto clonado superficialmente afecta a ambos",
          "const evita que la variable sea reasignada, pero las propiedades del objeto aún pueden modificarse",
          "Los objetos solo pueden almacenar valores de cadena, nunca funciones ni arreglos",
    ...
    },
    {
      ...
      description:
        "Rastrea las referencias que apuntan al mismo objeto en memoria.",
      isCodeTracing: true,
      question: {
        questionText:
          "¿Qué se imprimirá para usuarioA.puntaje tras ejecutar este código?",
    ...
    },
    {
      ...
      description:
        "Organiza la extensión de clases y la llamada al constructor padre.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las líneas para crear una clase Empleado que herede de Persona:",
        lines: [
    ...
    },
    {
      ...
      description:
        "Explica por qu\xE9 evitar la mutaci\xF3n directa de objetos es cr\xEDtico.",
      isText: true,
      question: {
        questionText:
          "\xBFPor qu\xE9 es importante la inmutabilidad al modificar objetos o arreglos en aplicaciones de JavaScript? Explica qu\xE9 problemas genera la mutaci\xF3n directa.",
      },
    },
    {
      group: "2",
      ...
      description:
        "Selecciona el operador que lee propiedades anidadas de forma segura.",
      isCodeCompletion: true,
      question: {
        questionText:
          "\xBFQu\xE9 operador accede de forma segura a propiedades anidadas cuando una propiedad intermedia puede ser null o undefined?",
    ...
    },
    {
      ...
      description:
        "Rastrea la instanciación de clases y métodos para calcular el estado interno.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predice el valor final de count tras llamar a increment(3):",
    ...
    },
    {
      ...
      question: {
        questionText:
          "En un entorno de terminal Bash, ingresa el comando echo para imprimir 'Data ready'",
      },
    },
    {
      group: "2",
      ...
      isConversationReview: true,
      description:
        "Observa cómo tu app obtiene un modelo de datos estructurado con objetos, clases y colecciones.",
      question: {
        questionText:
          "Tu app ya tiene datos estructurados. ¡Conectemos objetos y colecciones con tu idea!",
        range: [40, 56],
      },
    },
    {
      ...
      description:
        "Relaciona los elementos HTML semánticos con sus funciones de diseño y contenido.",
      isMatchPairs: true,
      question: {
        ...
        pairs: [
          {
            left: "<header>",
            right:
              "Contenido introductorio, título del sitio o navegación superior",
          },
          {
            left: "<main>",
          ...
          },
          {
            left: "<section>",
            right:
              "Una agrupación temática independiente de contenido relacionado",
          },
          {
            left: "<footer>",
            right:
              "Información de cierre, avisos de copyright o enlaces del autor",
          },
        ],
        choices: [
          "Contenido introductorio, título del sitio o navegación superior",
          "El contenido principal y único del cuerpo del documento",
          "Una agrupación temática independiente de contenido relacionado",
          "Información de cierre, avisos de copyright o enlaces del autor",
        ],
        answer: {
    ...
    },
    {
      ...
      description:
        "Completa un elemento input con el tipo y texto de marcador de posición correctos.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa la etiqueta input para aceptar correos electrónicos con un texto de ayuda:",
        template:
    ...
    },
    {
      ...
      description:
        "Selecciona el elemento accesible para activar acciones interactivas.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué implementación proporciona soporte nativo de accesibilidad por teclado y lectores de pantalla para un botón?",
        options: [
          '<button\n  type="button"\n  onClick={handleClick}\n>\n  Enviar\n</button>',
          "<div onClick={handleClick}>\n  Enviar\n</div>",
          "<span onClick={handleClick}>\n  Enviar\n</span>",
    ...
    },
    {
      ...
      description:
        "Agrega texto alternativo significativo para que una imagen HTML sea accesible.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige la imagen HTML para que un lector de pantalla pueda comunicar lo que representa:",
        starterCode: '<img src="perfil.jpg">',
        answer: '<img src="perfil.jpg" alt="Perfil del usuario">',
        tests: [
          "Incluye un atributo alt significativo",
          "Conserva la fuente original de la imagen",
        ],
      },
    },
    {
      ...
      description:
        "Completa las etiquetas sem\xE1nticas de HTML para crear una tarjeta de producto interactiva.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa los elementos sem\xE1nticos de HTML para armar la tarjeta de producto:",
        template:
    ...
    },
    {
      ...
      description:
        "Ordena las capas concéntricas del modelo de caja desde el interior hacia el exterior.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena las capas del modelo de caja en CSS de adentro hacia afuera:",
        options: [
          "1. Área de contenido (dimensiones de texto o imagen)",
          "2. Padding (espacio alrededor del contenido dentro del borde)",
          "3. Border (línea que rodea el padding)",
          "4. Margin (espacio exterior fuera del borde entre elementos)",
        ],
        answer: [
          "1. Área de contenido (dimensiones de texto o imagen)",
          "2. Padding (espacio alrededor del contenido dentro del borde)",
    ...
    },
    {
      ...
      description:
        "Relaciona las propiedades de espaciado en CSS con su impacto dimensional.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada propiedad de diseño en CSS con su efecto en el elemento:",
        pairs: [
          {
            left: "box-sizing: border-box",
          ...
          },
          {
            left: "margin: 0 auto",
            right:
              "Centra horizontalmente un elemento de bloque con ancho definido",
          },
          {
            left: "gap: 16px",
            right:
              "Define el espacio entre elementos hijos dentro de flex o grid",
          },
          {
            left: "overflow: hidden",
            right:
              "Recorta el contenido hijo que exceda los límites del contenedor",
          },
        ],
        choices: [
          "Incluye padding y borde dentro del ancho declarado",
          "Centra horizontalmente un elemento de bloque con ancho definido",
          "Define el espacio entre elementos hijos dentro de flex o grid",
          "Recorta el contenido hijo que exceda los límites del contenedor",
        ],
    ...
    },
    {
      ...
      description:
        "Identifica la funci\xF3n matem\xE1tica de CSS para dise\xF1o responsivo fluido.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFQu\xE9 funci\xF3n matem\xE1tica de CSS acepta un valor m\xEDnimo, preferido y m\xE1ximo para lograr tama\xF1os fluidos sin media queries?",
        answer: "clamp()",
      },
    },
    {
      ...
      description:
        "Selecciona todas las t\xE9cnicas v\xE1lidas para evitar desbordamientos horizontales.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "\xBFQu\xE9 t\xE9cnicas ayudan a prevenir desbordamientos horizontales no deseados en pantallas m\xF3viles?",
        options: [
          "Usar box-sizing: border-box globalmente en todos los elementos",
          "Usar max-width: 100% en im\xE1genes y contenedores multimedia",
          "Evitar anchos fijos grandes en p\xEDxeles (usar porcentajes, flex o rem)",
          "Colocar min-width: 2000px en todos los contenedores",
        ],
        answer: [
          "Usar box-sizing: border-box globalmente en todos los elementos",
          "Usar max-width: 100% en im\xE1genes y contenedores multimedia",
    ...
    },
    {
      ...
      description:
        "Ordena las reglas de flexbox para crear una barra de navegación horizontal espaciada.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las reglas de CSS flexbox para crear una barra de navegación con espacio entre elementos:",
        lines: [
          ".navbar {",
          "  display: flex;",
          "  justify-content: space-between;",
    ...
    },
    {
      ...
      description:
        "Escribe un componente funcional de React que renderice un input controlado.",
      isCode: true,
      question: {
        questionText:
          "Escribe un componente SearchInput({ query, setQuery }) que enlace value y onChange para controlar un input:",
        starterCode:
          "function SearchInput({ query, setQuery }) {\n  // Devuelve un input de texto controlado.\n}",
        answer:
          'function SearchInput({ query, setQuery }) {\n  return (\n    <input\n      type="text"\n      value={query}\n      onChange={(e) => setQuery(e.target.value)}\n      placeholder="Buscar..."\n    />\n  );\n}',
        tests: [
          "Renderiza un elemento input",
          "Enlaza value a query y actualiza mediante onChange",
        ],
      },
    },
    {
      ...
      description:
        "Completa el filtro para buscar productos por título sin distinción de mayúsculas.",
      isFillCodeBlanks: true,
      question: {
    ...
    },
    {
      ...
      description:
        "Refactoriza lecturas directas del DOM a vinculación controlada con useState.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la lectura imperativa de document.getElementById a un input controlado con useState:",
        starterCode:
        ...
        tests: [
          "Utiliza useState('') para el nombre",
          "Vincula value y onChange al input",
        ],
      },
    },
    {
      ...
      description:
        "Escribe una funci\xF3n auxiliar para actualizar campos de formulario de forma inmutable.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n actualizarCampo(formulario, campo, valor) que devuelva un nuevo objeto con el campo actualizado de forma inmutable:",
        starterCode:
          "function actualizarCampo(formulario, campo, valor) {\n  // Devuelve un objeto nuevo con el campo solicitado actualizado.\n}",
        answer:
          "function actualizarCampo(formulario, campo, valor) {\n  return {\n    ...formulario,\n    [campo]: valor\n  };\n}",
        tests: [
          "Devuelve un nuevo objeto sin mutar el original",
          "Actualiza la clave din\xE1mica correctamente",
        ],
      },
    },
    {
      ...
      description:
        "Localiza la línea que limpia el campo de texto a una cadena vacía.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea que restablece el campo a una cadena vacía tras guardar:",
        code: "const handleAddTodo = (e) => {\n  e.preventDefault();\n  if (!text.trim()) return;\n  setTodos(prev => [...prev, text]);\n  setText('');\n};",
        answer: 5,
      },
    },
    {
      ...
      description:
        "Renderiza componentes alternativos según una bandera booleana de autenticación.",
      isCodeCompletion: true,
      question: {
        questionText:
          "¿Qué expresión JSX renderiza Dashboard cuando estaConectado es verdadero y LoginView en caso contrario?",
        options: [
          "{estaConectado ? <Dashboard /> : <LoginView />}",
          "{if (estaConectado) <Dashboard /> else <LoginView />}",
          "{estaConectado && <Dashboard /> || <LoginView />}",
          "{estaConectado ? <Dashboard /> , <LoginView />}",
        ],
    ...
    },
    {
      ...
      description:
        "Identifica las reglas sintácticas obligatorias al escribir JSX en React.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todas las reglas de sintaxis válidas requeridas al escribir JSX:",
        options: [
          "Todas las etiquetas deben cerrarse explícitamente (p. ej. <img /> o <br />)",
          "Los componentes deben devolver un único elemento raíz o Fragment (<>...</>)",
          "Usar atributos en camelCase como className y htmlFor en lugar de class y for",
          "Las expresiones JavaScript en JSX deben encerrarse entre llaves {}",
          "Los nombres de clase en HTML deben escribirse siempre en mayúsculas",
        ],
        answer: [
          "Todas las etiquetas deben cerrarse explícitamente (p. ej. <img /> o <br />)",
          "Los componentes deben devolver un único elemento raíz o Fragment (<>...</>)",
    ...
    },
    {
      ...
      question: {
        questionText:
          "Ordena la jerarquía de retornos condicionales para una vista asíncrona:",
        lines: [
          "if (cargando) return <Spinner />;",
          "if (error) return <MensajeError msg={error} />;",
          "return <ListaDatos items={datos} />;",
        ],
        answer: [
          "if (cargando) return <Spinner />;",
          "if (error) return <MensajeError msg={error} />;",
    ...
    },
    {
      ...
      description:
        "Predice qué elemento se renderiza cuando la lista de elementos está vacía.",
      isCodeTracing: true,
      question: {
    ...
    },
    {
      ...
      description:
        "Selecciona la implementación más declarativa para alternar vistas.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué implementación de pestañas renderiza limpiamente las vistas según el estado activo?",
        options: [
    ...
    },
    {
      ...
      description:
        "Inicia la fase de React conectando funciones de JavaScript, props y JSX renderizado.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Qué es un componente funcional de React en el desarrollo web moderno?",
        options: [
          "Una función JavaScript que acepta props y devuelve JSX describiendo lo que debe aparecer en pantalla.",
          "Un custom hook que solo devuelve estado y nunca puede devolver JSX.",
          "Un controlador de eventos que reemplaza directamente el DOM cada vez que cambia el estado.",
    ...
    },
    {
      ...
      description:
        "Explica c\xF3mo React optimiza el renderizado usando el Virtual DOM.",
      isText: true,
      question: {
        questionText:
          "Explica c\xF3mo el algoritmo de reconciliaci\xF3n y el Virtual DOM de React optimizan los cambios en el DOM real. \xBFPor qu\xE9 es m\xE1s eficiente?",
      },
    },
    {
      group: "3",
      ...
      description:
        "Rastrea la reejecución de un componente cuando se actualiza el estado.",
      isCodeTracing: true,
      question: {
        questionText:
          "En una compilación de producción sin un contenedor StrictMode, ¿cuántas veces se imprimirá 'Render App' si el botón se presiona dos veces?",
        code: "function App() {\n  const [count, setCount] = React.useState(0);\n  console.log('Render App');\n  return <button onClick={() => setCount(c => c + 1)}>Click {count}</button>;\n}",
        options: [
          "3 veces (1 renderizado inicial de montaje + 2 re-renderizados por clic)",
          "2 veces (solo los clics re-renderizan)",
          "1 vez (los componentes se ejecutan una sola vez)",
          "0 veces (las funciones no ejecutan registros de consola)",
        ],
        answer:
          "3 veces (1 renderizado inicial de montaje + 2 re-renderizados por clic)",
      },
    },
    {
      ...
      description:
        "Corrige el controlador para actualizar el contador de forma inmutable usando setCount.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el controlador para llamar a setCount en lugar de reasignar count directamente:",
        starterCode:
          "function Contador() {\n  let [count, setCount] = useState(0);\n  const handleIncrement = () => {\n    count = count + 1;\n  };\n  return <button onClick={handleIncrement}>{count}</button>;\n}",
        answer:
          "function Contador() {\n  const [count, setCount] = useState(0);\n  const handleIncrement = () => {\n    setCount(c => c + 1);\n  };\n  return <button onClick={handleIncrement}>{count}</button>;\n}",
        tests: [
          "Utiliza setCount(c => c + 1) o setCount(count + 1)",
          "Provoca el re-renderizado del componente al hacer clic",
        ],
      },
    },
    {
      ...
      description:
        "Comprende cómo React envuelve eventos nativos en SyntheticEvents compatibles.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Por qué React envuelve los eventos del DOM nativo en SyntheticEvents?",
        options: [
          "Para proporcionar un comportamiento y propiedades coherentes en todos los navegadores web.",
          "Para evitar que se disparen eventos de teclado en el navegador.",
          "Para enviar automáticamente cada clic a una base de datos remota.",
          "Para convertir todos los clics izquierdos en clics derechos.",
        ],
        answer:
          "Para proporcionar un comportamiento y propiedades coherentes en todos los navegadores web.",
      },
    },
    {
      ...
      description:
        "Identifica el hook principal para manejo de estado en componentes funcionales.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFCu\xE1l es el nombre del hook est\xE1ndar de React utilizado para declarar y actualizar variables de estado local en componentes funcionales?",
        answer: "useState",
      },
    },
    {
      ...
      description:
        "Explica la diferencia entre props y estado en la arquitectura de componentes.",
      isText: true,
      question: {
        questionText:
          "Explica las diferencias fundamentales entre props y state en React. \xBFC\xF3mo fluyen los datos entre componentes padre e hijo?",
      },
    },
    {
      group: "3",
      ...
      description:
        "Localiza el elemento mapeado que carece de la propiedad única key.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde el elemento mapeado carece de la propiedad única key:",
    ...
    },
    {
      ...
      description:
        "Rastrea el flujo de datos desde el estado del padre hacia un componente hijo.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predice qué texto se mostrará en el botón hijo tras hacer clic una vez:",
    ...
    },
    {
      ...
      question: {
        questionText:
          "En un entorno de terminal Bash, ingresa el comando para listar los archivos del directorio actual",
      },
    },
    {
      group: "3",
      ...
      question: {
        questionText:
          "Relaciona cada técnica de estilo con su sintaxis de implementación:",
        pairs: [
          {
          ...
          },
          {
            left: "Módulos CSS",
            right:
              'import styles from "./Boton.module.css"; className={styles.btn}',
          },
          {
        ...
        choices: [
          ...
          'import styles from "./Boton.module.css"; className={styles.btn}',
          'className="bg-blue-500 p-3 rounded-lg text-white"',
          'className="boton-personalizado" con hoja de estilos global',
        ],
        answer: {
          "Objeto de Estilo en Línea":
            'style={{ backgroundColor: "#3b82f6", padding: 12 }}',
          "Módulos CSS":
            'import styles from "./Boton.module.css"; className={styles.btn}',
    ...
    },
    {
      ...
      description:
        "Ordena las reglas de CSS para centrar vertical y horizontalmente el contenido de una tarjeta.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena las reglas de CSS para centrar el contenido de la tarjeta en una columna:",
        options: [
          "1. display: flex;",
          "2. flex-direction: column;",
          "3. align-items: center;",
    ...
    },
    {
      ...
      description:
        "Eleva el estado del hijo al padre para que múltiples componentes compartan datos.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza el estado dentro de InputBusqueda hacia el componente padre PaginaBusqueda:",
        starterCode:
        ...
        tests: [
          "Define const [consulta, setConsulta] en PaginaBusqueda",
          "Pasa la consulta a ResultadosBusqueda",
        ],
      },
    },
    {
      ...
      description:
        "Explica qu\xE9 es un efecto secundario y por qu\xE9 se requiere useEffect.",
      isText: true,
      question: {
        questionText:
          "\xBFQu\xE9 es un efecto secundario en React y por qu\xE9 operaciones como peticiones a APIs, suscripciones o temporizadores deben ir dentro de useEffect?",
      },
    },
    {
      group: "3",
      ...
      description:
        "Ordena las fases cronológicas desde el montaje inicial hasta el desmontaje.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena cronológicamente las fases del ciclo de vida de un componente en React:",
        options: [
          "1. Renderizado inicial del componente (Montaje)",
          "2. Ejecución de funciones de configuración en useEffect",
          "3. Actualización de estado o prop provoca re-renderizado",
          "4. El componente se desmonta y ejecuta la limpieza de useEffect",
        ],
        answer: [
          "1. Renderizado inicial del componente (Montaje)",
          "2. Ejecución de funciones de configuración en useEffect",
    ...
    },
    {
      ...
      description:
        "Ordena las etapas para obtener datos de forma asíncrona y gestionar estados de carga.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena los pasos para obtener datos de forma segura en useEffect:",
        options: [
          "1. Establecer el estado de carga en verdadero",
          "2. Ejecutar await fetch(endpoint)",
          "3. Parsear el JSON de respuesta y actualizar el estado de datos",
          "4. Capturar posibles errores y establecer la carga en falso",
        ],
        answer: [
          "1. Establecer el estado de carga en verdadero",
          "2. Ejecutar await fetch(endpoint)",
    ...
    },
    {
      ...
      description:
        "Selecciona la actualización de estado que añade un nuevo elemento sin mutar.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué implementación de setter añade correctamente una publicación al inicio del feed?",
        options: [
          "setPosts((prev) => [\n  newPost,\n  ...prev\n]);",
          "posts.unshift(newPost);\nsetPosts(posts);",
          "setPosts(posts + newPost);",
    ...
    },
    {
      ...
      description:
        "Elige la forma confiable de actualizar estado cuando el siguiente valor depende del anterior.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Por qué setCount((actual) => actual + 1) es más seguro que setCount(count + 1) cuando pueden acumularse varias actualizaciones?",
        options: [
          "React entrega a cada actualizador el estado más reciente de la cola y evita calcular desde un valor obsoleto.",
          "El actualizador modifica count directamente sin renderizar.",
          "Los setters de React solo aceptan funciones y nunca valores.",
          "El actualizador impide que el componente vuelva a renderizarse.",
        ],
        answer:
          "React entrega a cada actualizador el estado más reciente de la cola y evita calcular desde un valor obsoleto.",
      },
    },
    {
      ...
      description:
        "Extrae la lógica de obtención de datos a un hook personalizado useFetch.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Extrae la lógica de obtención de datos a un custom hook useFetch reutilizable:",
        starterCode:
          "function Perfil({ url }) {\n  const [data, setData] = useState(null);\n  useEffect(() => {\n    fetch(url)\n      .then((r) => r.json())\n      .then(setData);\n  }, [url]);\n  return <div>{data?.nombre}</div>;\n}",
        answer:
          "function useFetch(url) {\n  const [data, setData] = useState(null);\n  useEffect(() => {\n    fetch(url)\n      .then((r) => r.json())\n      .then(setData);\n  }, [url]);\n  return data;\n}",
        tests: [
          "Define la función useFetch(url)",
          "Devuelve el estado de datos obtenidos",
        ],
      },
    },
    {
      ...
      description:
        "Completa el arreglo de dependencias para evitar ciclos infinitos de re-renderizado.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa el arreglo de dependencias vac\xEDo para asegurar que el efecto se ejecute solo una vez al montar el componente:",
        template: "useEffect(() => {\n  obtenerDatos();\n}, {{[]}});",
        blanks: [
          {
            key: "[]",
    ...
    },
    {
      ...
      description:
        "Selecciona todos los criterios válidos para el uso de la propiedad key en React.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todas las afirmaciones verdaderas sobre la propiedad key en listas de React:",
        options: [
          "Las keys permiten a React identificar qué elementos han cambiado, agregado o eliminado",
          "Las keys deben ser identificadores únicos y estables (p. ej. item.id) en lugar de índices",
          "Usar Math.random() como key fuerza el re-montaje innecesario de elementos en cada render",
          "Las keys se pasan automáticamente a componentes hijos como props regulares accesibles por props.key",
          "Las keys solo se requieren si la lista supera los 1000 elementos",
        ],
        answer: [
          "Las keys permiten a React identificar qué elementos han cambiado, agregado o eliminado",
          "Las keys deben ser identificadores únicos y estables (p. ej. item.id) en lugar de índices",
    ...
    },
    {
      ...
      description:
        "Ordena las líneas para pasar un callback desde el padre al hijo para actualizar el estado.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las líneas de un componente padre que gestiona el cambio de estado de un elemento hijo:",
        lines: [
          "function AppTareas() {",
          "  const [tareas, setTareas] = useState([]);",
          "  const toggle = (id) => {",
          "    setTareas(t => update(t, id));",
          "  };",
          "  return <ListaTareas items={tareas} onToggle={toggle} />;",
          "}",
        ],
        answer: [
          "function AppTareas() {",
    ...
    },
    {
      ...
      description:
        "Localiza la falta de arreglo de dependencias que desencadena un bucle infinito.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde la falta del arreglo de dependencias causa que el efecto se ejecute en cada re-render:",
    ...
    },
    {
      group: "3",
      title:
        "Respuesta Corta: Convenci\xF3n de Nombre para Hooks Personalizados",
      description:
        "Identifica el prefijo obligatorio para hooks personalizados en React.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFCon qu\xE9 prefijo de dos letras debe comenzar el nombre de cualquier hook personalizado en React por convenci\xF3n (ej. useWindowSize)?",
        answer: "use",
      },
    },
    {
      ...
      description:
        "Rastrea valores computados directamente durante el render sin llamadas adicionales a setState.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predice qué se imprimirá para totalActivos durante el renderizado:",
    ...
    },
    {
      ...
      description:
        "Envuelve componentes JSX arbitrarios dentro de un diseño Modal reutilizable.",
      isCodeCompletion: true,
      question: {
        questionText:
          "¿Qué componente modal renderiza limpiamente contenido hijo dentro de su contenedor?",
        options: [
          'function Modal({ title, children }) {\n  return (\n    <div className="modal-backdrop">\n      <h2>{title}</h2>\n      <div className="modal-body">\n        {children}\n      </div>\n    </div>\n  );\n}',
          "function Modal({ title }) {\n  return <h2>{title}</h2>;\n}",
          "function Modal(children) {\n  return (\n    <div>\n      {children()}\n    </div>\n  );\n}",
    ...
    },
    {
      ...
      description:
        "Usa AbortController para detener una solicitud en curso durante la limpieza del efecto.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el efecto para cancelar la solicitud fetch si el componente se desmonta antes de recibir la respuesta:",
        starterCode:
        ...
        tests: [
          ...
          "Pasa controller.signal a fetch",
          "Llama controller.abort durante la limpieza",
        ],
      },
    },
    {
      ...
      description:
        "Escribe una funci\xF3n que filtre usuarios activos y obtenga sus nombres.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n obtenerNombresActivos(usuarios) que filtre los usuarios donde isActive sea true y devuelva un arreglo con sus nombres:",
        starterCode:
          "function obtenerNombresActivos(usuarios) {\n  // Filtra usuarios activos y después devuelve sus nombres.\n}",
        answer:
          "function obtenerNombresActivos(usuarios) {\n  return usuarios\n    .filter((u) => u.isActive)\n    .map((u) => u.nombre || u.name);\n}",
        tests: [
          "Filtra los usuarios inactivos",
          "Devuelve un arreglo con los nombres",
        ],
      },
    },
    {
      ...
      description:
        "Comprende cómo devolver una función de limpieza desde useEffect para cancelar temporizadores y evitar fugas de memoria.",
      showPreview: true,
      isCodeCompletion: true,
      question: {
        questionText:
          "¿Qué implementación de useEffect inicia correctamente un temporizador de intervalo y lo limpia en la función de retorno?",
        previewCode:
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "Observa cómo tu app evoluciona de HTML semántico y CSS responsivo a una interfaz interactiva en React.",
      question: {
        questionText:
          "Tu app ya tiene una interfaz responsiva e interactiva. ¡Celebremos lo que cambió!",
        range: [58, 106],
      },
    },
    {
      ...
      description:
        "Relaciona los verbos HTTP principales con las operaciones CRUD de base de datos.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada método de solicitud HTTP con su función principal en la API:",
        pairs: [
          {
            left: "GET",
        ...
        choices: [
          "Recuperar datos o leer recursos desde el servidor",
          "Crear un nuevo recurso con un cuerpo de solicitud",
          "Actualizar o modificar un recurso existente",
          "Eliminar un recurso especificado de la base de datos",
        ],
        answer: {
    ...
    },
    {
      ...
      description:
        "Identifica el c\xF3digo de estado HTTP est\xE1ndar para recursos no encontrados.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFQu\xE9 c\xF3digo de estado HTTP de 3 d\xEDgitos indica que el recurso o endpoint solicitado no fue encontrado en el servidor?",
        answer: "404",
      },
    },
    {
      ...
      description:
        "Comprende la E/S sin bloqueo y cómo se resuelven las promesas en JavaScript.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Por qué Node.js utiliza E/S asíncrona y sin bloqueo para operaciones de red y base de datos?",
        options: [
          "Permite que JavaScript continúe trabajando mientras el entorno espera la E/S y después encola el callback o la continuación de la promesa.",
          "Hace que todas las operaciones de base de datos terminen al mismo tiempo y en cualquier orden.",
          "Garantiza que las solicitudes de red nunca fallen ni agoten su tiempo.",
          "Mueve cada función de JavaScript a su propio proceso del sistema operativo.",
        ],
        answer:
          "Permite que JavaScript continúe trabajando mientras el entorno espera la E/S y después encola el callback o la continuación de la promesa.",
      },
    },
    {
      ...
      description:
        "Ordena las líneas para obtener y parsear datos JSON de un endpoint de forma asíncrona.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las líneas en una función completa de obtención de datos asíncrona:",
        lines: [
    ...
    },
    {
      ...
      description:
        "Escribe una ruta GET en Express que responda con JSON de estado.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n registrarRutaSalud(app) que registre una ruta GET en '/api/health' respondiendo con status 200 y JSON { status: 'healthy' }:",
        starterCode:
          "function registrarRutaSalud(app) {\n  // Registra GET /api/health y devuelve la respuesta solicitada.\n}",
        answer:
          "function registrarRutaSalud(app) {\n  app.get('/api/health', (req, res) => {\n    res.status(200).json({\n      status: 'healthy'\n    });\n  });\n}",
        tests: [
          "Registra GET /api/health",
          "Responde con status 200 y JSON correcto",
        ],
      },
    },
    {
      ...
      description:
        "Extrae los datos entrantes y responde con el estado 201 Created.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa el controlador POST para parsear req.body y responder con estado 201:",
        template:
    ...
    },
    {
      ...
      description:
        "Agrega el await faltante para no enviar promesas sin resolver en la respuesta.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el controlador asíncrono para esperar la consulta antes de enviar la respuesta JSON:",
        starterCode:
          "app.get('/api/usuarios', async (req, res) => {\n  const usuarios = db.getUsuarios();\n  res.json(usuarios);\n});",
        answer:
          "app.get('/api/usuarios', async (req, res) => {\n  const usuarios = await db.getUsuarios();\n  res.json(usuarios);\n});",
        tests: [
          "Espera a db.getUsuarios() antes de responder",
          "Envía los registros resueltos de usuarios",
        ],
      },
    },
    {
      ...
      description:
        "Refactoriza callbacks a una función asíncrona moderna con async/await.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la consulta basada en callbacks a una función moderna con async/await:",
        starterCode:
          "function obtenerUsuario(id, callback) {\n  db.find(id, (err, usuario) => {\n    if (err) return callback(err);\n    callback(null, usuario);\n  });\n}",
        answer:
          "async function obtenerUsuario(id) {\n  const usuario = await db.find(id);\n  return usuario;\n}",
        tests: [
          "Utiliza la sintaxis async/await",
          "Devuelve directamente el objeto usuario resuelto",
        ],
      },
    },
    {
      ...
      question: {
        questionText:
          "Compara bases de datos relacionales (SQL) con bases de datos documentales (NoSQL) como Firestore. \xBFEn qu\xE9 escenarios es preferible un esquema NoSQL flexible?",
      },
    },
    {
      group: "4",
      ...
      description:
        "Selecciona la consulta parametrizada que previene inyecciones SQL.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué implementación utiliza parámetros seguros para prevenir ataques de inyección SQL?",
        options: [
          ...
          "const resultado = await db.query('SELECT * FROM usuarios WHERE correo = ' + correo);",
          "const resultado = await db.query(eval(`SELECT * FROM usuarios WHERE correo = ${correo}`));",
        ],
        answer:
          "const resultado = await db.query('SELECT * FROM usuarios WHERE correo = $1', [correo]);",
      },
    },
    {
      ...
      description:
        "Ordena los pasos del ciclo de vida de autenticación basada en tokens.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena los pasos cronológicos en un flujo de autenticación basado en tokens:",
        options: [
          "1. El cliente envía las credenciales a /auth/login",
          "2. El servidor valida las credenciales y firma un JWT",
          "3. El cliente almacena el token en memoria o almacenamiento seguro",
          "4. El cliente envía el token en el encabezado Authorization Bearer en las solicitudes API",
        ],
        answer: [
          "1. El cliente envía las credenciales a /auth/login",
          "2. El servidor valida las credenciales y firma un JWT",
    ...
    },
    {
      ...
      description:
        "Identifica cómo se vinculan los registros padre e hijo en un modelo relacional.",
      isCodeCompletion: true,
      question: {
        questionText:
          "¿Qué esquema vincula correctamente la tabla 'comentarios' con un autor en la tabla 'usuarios'?",
        options: [
    ...
    },
    {
      ...
      description:
        "Corrige el código HTTP para devolver 404 cuando un usuario no existe.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el código de estado para devolver 404 cuando no se encuentre el usuario:",
        starterCode:
          "app.get('/api/usuarios/:id', async (req, res) => {\n  const usuario = await db.find(req.params.id);\n  if (!usuario) {\n    return res.status(200).json({\n      error: 'Usuario no encontrado'\n    });\n  }\n  res.json(usuario);\n});",
        answer:
          "app.get('/api/usuarios/:id', async (req, res) => {\n  const usuario = await db.find(req.params.id);\n  if (!usuario) {\n    return res.status(404).json({\n      error: 'Usuario no encontrado'\n    });\n  }\n  res.json(usuario);\n});",
        tests: [
          "Devuelve estado 404 cuando usuario es null",
    ...
    },
    {
      ...
      description:
        "Completa la referencia a la variable de entorno para firmar el token JWT.",
      isFillCodeBlanks: true,
      question: {
        questionText:
          "Completa la referencia a process.env para cargar la clave secreta din\xE1micamente sin dejarla en texto plano:",
        template:
    ...
    },
    {
      ...
      description:
        "Selecciona el middleware de verificación de tokens más robusto en Express.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué middleware valida correctamente los tokens Bearer del encabezado de autorización?",
        options: [
          "const authGuard = (req, res, next) => {\n  const token =\n    req.headers.authorization?.split(' ')[1];\n  if (!token) {\n    return res.status(401).json({\n      error: 'Unauthorized'\n    });\n  }\n  try {\n    req.user = jwt.verify(\n      token,\n      process.env.JWT_SECRET\n    );\n    next();\n  } catch (err) {\n    res.status(403).json({\n      error: 'Invalid token'\n    });\n  }\n};",
          "const authGuard = (req, res, next) => {\n  next();\n};",
          "const authGuard = (req, res, next) => {\n  if (req.url) next();\n};",
    ...
    },
    {
      ...
      description:
        "Ordena las líneas para configurar middleware y rutas en Express.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena las líneas para configurar el middleware express.json antes de la ruta de la API:",
        lines: [
          "const app = express();",
          "app.use(express.json());",
          'app.get("/api/salud", (req, res) => {',
          '  res.json({ estado: "saludable" });',
          "});",
          "app.listen(3000);",
        ],
        answer: [
    ...
    },
    {
      ...
      description:
        "Selecciona todas las medidas de seguridad críticas para servidores de producción.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todas las mejores prácticas de seguridad para servidores API:",
        options: [
          "Sanitizar y validar toda la entrada entrante del usuario",
          "Implementar limitación de tasa para prevenir ataques de fuerza bruta",
          "Almacenar contraseñas usando hashes criptográficos con sal (p. ej. bcrypt)",
          "Usar HTTPS / TLS para cifrar todo el tráfico en tránsito",
          "Exponer credenciales de base de datos directamente en paquetes del cliente",
          "Deshabilitar comprobaciones CORS para todos los dominios con comodín *",
        ],
        answer: [
          "Sanitizar y validar toda la entrada entrante del usuario",
          "Implementar limitación de tasa para prevenir ataques de fuerza bruta",
    ...
    },
    {
      ...
      description:
        "Identifica la línea donde el bloque catch intercepta errores de base de datos.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde el bloque catch intercepta errores para evitar caídas del servidor:",
    ...
    },
    {
      ...
      description:
        "Rastrea microtareas asíncronas vs salidas síncronas en Node.js.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predice el orden exacto de los mensajes registrados en consola al ejecutar este programa:",
    ...
    },
    {
      ...
      description:
        "Ejecuta un comando para probar un endpoint desde la terminal.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "En un terminal Bash, usa curl para realizar una solicitud GET a 'https://api.example.com/health'",
      },
    },
    {
      group: "4",
      ...
      description:
        "Localiza la línea donde se configura el permiso de origen en CORS.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde se configura el origen permitido en CORS:",
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "Observa cómo tu app obtiene rutas backend, datos persistentes, manejo de errores y autenticación.",
      question: {
        questionText:
          "Tu app ya puede comunicarse con un backend y proteger datos. ¡Agreguemos ese progreso al proyecto!",
        range: [108, 128],
      },
    },
    {
      ...
      description:
        "Compara plataformas backend gestionadas con infraestructura aprovisionada por tu equipo.",
      isMultipleChoice: true,
      question: {
        questionText:
          "¿Qué compromiso distingue mejor a una plataforma gestionada como Firebase o Supabase de operar tu propio VPS?",
        options: [
          "El proveedor gestiona gran parte del aprovisionamiento, escalado y parches, mientras la app acepta restricciones y precios específicos de la plataforma.",
          "Tu equipo obtiene control total del sistema operativo, pero debe configurar capacidad y parches manualmente.",
          "La plataforma puede alojar archivos estáticos, pero no ofrece autenticación ni bases de datos.",
          "La plataforma siempre cuesta menos que un VPS sin importar el nivel de tráfico.",
        ],
        answer:
          "El proveedor gestiona gran parte del aprovisionamiento, escalado y parches, mientras la app acepta restricciones y precios específicos de la plataforma.",
      },
    },
    {
      ...
      description:
        "Escribe una funci\xF3n auxiliar para extraer configuraci\xF3n de process.env con valores por defecto.",
      isCode: true,
      question: {
        questionText:
          "Escribe una funci\xF3n obtenerConfigBD() que extraiga DB_HOST y DB_PORT de process.env con valores por defecto ('localhost' y 5432):",
        starterCode:
          "function obtenerConfigBD() {\n  // Lee DB_HOST y DB_PORT e incluye ambos valores por defecto.\n}",
        answer:
          "function obtenerConfigBD() {\n  return {\n    host: process.env.DB_HOST || 'localhost',\n    port: Number(process.env.DB_PORT) || 5432\n  };\n}",
        tests: [
          "Devuelve claves host y port",
          "Aplica valores por defecto si no existen las variables",
        ],
      },
    },
    {
      ...
      description:
        "Identifica el comando de Git para guardar una versi\xF3n en el historial.",
      isSingleLineText: true,
      question: {
        questionText:
          "\xBFQu\xE9 comando de Git se utiliza para registrar los archivos preparados en el historial con un mensaje descriptivo (ej. con la opci\xF3n -m)?",
        answer: "git commit",
      },
    },
    {
      ...
      description:
        "Ordena las líneas para crear un commit y sincronizarlo con GitHub.",
      isParsonsProblem: true,
      question: {
        questionText:
          "Ordena los comandos cronológicos de Git para preparar, confirmar y subir cambios:",
        lines: [
          "git status",
          "git add .",
          'git commit -m "feat: agregar flujo de mensajes en tiempo real"',
          "git push origin main",
        ],
        answer: [
          "git status",
    ...
    },
    {
      ...
      description:
        "Clona un repositorio remoto en tu computadora desde la terminal.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "En un entorno de terminal Bash, ingresa el comando para clonar https://github.com/example/web-app.git",
      },
    },
    {
      group: "5",
      ...
      description:
        "Corrige el objeto de configuración de Firebase para incluir projectId.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige la configuración de Firebase abajo para incluir projectId:",
        starterCode:
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  authDomain: 'app.firebaseapp.com'\n};\nconst app = initializeApp(firebaseConfig);",
        answer:
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  authDomain: 'app.firebaseapp.com',\n  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID\n};\nconst app = initializeApp(firebaseConfig);",
        tests: [
          "Incluye projectId desde import.meta.env",
          "Pasa una configuración de cliente válida de Vite a initializeApp",
        ],
      },
    },
    {
      ...
      description:
        "Refactoriza llamadas heredadas de Firebase v8 a funciones modulares de v9.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la llamada heredada a la sintaxis modular v9 de signInWithPopup:",
        starterCode:
          "function login(provider) {\n  return firebase.auth().signInWithPopup(provider);\n}",
        answer:
          "function login(provider) {\n  return signInWithPopup(auth, provider);\n}",
        tests: [
          "Utiliza signInWithPopup(auth, provider)",
          "Elimina la sintaxis de espacio de nombres heredada",
        ],
      },
    },
    {
      ...
      description:
        "Mantén el estado del cliente sincronizado con el inicio/cierre de sesión.",
      isFillCodeBlanks: true,
      question: {
    ...
    },
    {
      ...
      description:
        "Selecciona la implementación que se suscribe a Firestore y se limpia en el desmontaje.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué patrón de useEffect se suscribe a Firestore en tiempo real y cancela la suscripción al desmontar?",
        options: [
          "useEffect(() => {\n  const q = query(\n    collection(db, 'messages'),\n    orderBy('createdAt')\n  );\n\n  const unsubscribe = onSnapshot(\n    q,\n    (snapshot) => {\n      setMessages(\n        snapshot.docs.map((d) => ({\n          id: d.id,\n          ...d.data()\n        }))\n      );\n    }\n  );\n\n  return () => unsubscribe();\n}, []);",
          "useEffect(() => {\n  onSnapshot(\n    collection(db, 'messages'),\n    (s) => setMessages(s.docs)\n  );\n}, []);",
          "useEffect(() => {\n  const data = getDocs(\n    collection(db, 'messages')\n  );\n  setMessages(data);\n});",
    ...
    },
    {
      ...
      description:
        "Garantiza que los usuarios autenticados solo puedan leer y escribir su propio perfil.",
      isCodeCompletion: true,
      question: {
        questionText:
          "¿Qué regla de seguridad garantiza que los usuarios autenticados solo lean y escriban su propio documento de perfil?",
        options: [
    ...
    },
    {
      ...
      description:
        "Explica por qu\xE9 los secretos del servidor nunca deben incluirse en el c\xF3digo cliente.",
      isText: true,
      question: {
        questionText:
          "\xBFPor qu\xE9 es peligroso incluir claves privadas de API, credenciales de base de datos o tokens secretos dentro del c\xF3digo frontend o variables de entorno del cliente?",
      },
    },
    {
      group: "5",
      ...
      description:
        "Lee correctamente la configuración pública de Firebase en una aplicación Vite.",
      isBestImplementation: true,
      question: {
        questionText:
          "¿Qué fragmento lee correctamente la configuración pública de Firebase en Vite, donde los valores VITE_* se incluyen en el bundle y son visibles?",
        options: [
          "const firebaseConfig = {\n  apiKey: import.meta.env.VITE_FIREBASE_API_KEY,\n  projectId: import.meta.env.VITE_FIREBASE_PROJECT_ID\n};",
          "const firebaseConfig = {\n  apiKey: process.env.SECRET_PRIVATE_KEY\n};",
          "const firebaseConfig = window.env;",
    ...
    },
    {
      ...
      description:
        "Identifica la línea donde el bloque catch intercepta cuando el usuario cierra la ventana de login.",
      isRelevantLine: true,
      question: {
        questionText:
          "Selecciona la línea donde el bloque catch maneja la cancelación del popup:",
    ...
    },
    {
      ...
      description:
        "Relaciona comandos de gesti\xF3n de ramas en Git con sus operaciones.",
      isMatchPairs: true,
      question: {
        questionText:
          "Relaciona cada comando de flujo de ramas en Git con su operaci\xF3n exacta:",
        pairs: [
          {
        ...
        answer: {
          "git checkout -b funcion":
            "Crea y cambia a una nueva rama de funcionalidad",
          "git merge funcion":
            "Combina los commits de la rama en la rama actual",
          "git branch -d funcion":
            "Elimina una rama local que ya fue fusionada",
          "git pull origin main":
            "Descarga y combina los \xFAltimos cambios remotos",
        },
      },
    },
    {
      ...
      description:
        "Devuelve la función de limpieza desde useEffect para detener el listener al desmontar.",
      isFixBug: true,
      question: {
        questionText:
          "Corrige el hook useEffect para limpiar el escuchador de auth al desmontar:",
        starterCode:
          "useEffect(() => {\n  const unsubscribe = onAuthStateChanged(auth, setUser);\n}, []);",
        answer:
          "useEffect(() => {\n  const unsubscribe = onAuthStateChanged(auth, setUser);\n  return () => unsubscribe();\n}, []);",
    ...
    },
    {
      ...
      description:
        "Inicia el servidor local de desarrollo utilizando npm run dev.",
      isCode: true,
      isTerminal: true,
      question: {
        questionText:
          "En un terminal Bash, ingresa el comando para iniciar el servidor de desarrollo local usando npm",
      },
    },
    {
      group: "5",
      ...
      description:
        "Ordena las fases automatizadas estándar de Integración y Despliegue Continuos.",
      isSelectOrder: true,
      question: {
        questionText:
          "Ordena cronológicamente las fases de un pipeline CI/CD automatizado:",
        options: [
          "1. El desarrollador sube un commit a GitHub",
          "2. El pipeline de CI ejecuta la suite de pruebas automatizadas",
          "3. La herramienta de compilación genera el paquete optimizado de producción",
          "4. El pipeline de CD despliega los artefactos en el CDN global",
        ],
        answer: [
          "1. El desarrollador sube un commit a GitHub",
          "2. El pipeline de CI ejecuta la suite de pruebas automatizadas",
    ...
    },
    {
      ...
      description:
        "Extrae operaciones de base de datos en una función de servicio reutilizable.",
      isRefactoringChallenge: true,
      question: {
        questionText:
          "Refactoriza la escritura en Firestore en una función de servicio crearPublicacion aislada:",
        starterCode:
          "function handleGuardar(texto) {\n  addDoc(collection(db, 'publicaciones'), { texto, fecha: Date.now() });\n}",
        answer:
          "export const crearPublicacion = (texto) => {\n  return addDoc(collection(db, 'publicaciones'), { texto, fecha: Date.now() });\n};",
        tests: [
          "Exporta la función independiente crearPublicacion",
          "Devuelve la promesa de addDoc",
        ],
      },
    },
    {
      ...
      description:
        "Selecciona las métricas clave para supervisar aplicaciones web en vivo.",
      isMultipleAnswerChoice: true,
      question: {
        questionText:
          "Selecciona todas las métricas y herramientas vitales para monitorear aplicaciones web en producción:",
        options: [
          "Rastreo de errores en tiempo real en el cliente JS (p. ej. Sentry)",
          "Latencia de API y percentiles de tiempo de respuesta (p95 / p99)",
          "Core Web Vitals y Largest Contentful Paint (LCP)",
          "Cuotas de lectura/escritura en base de datos y tiempos de consulta",
          "Temperatura física de la pantalla del usuario",
        ],
        answer: [
          "Rastreo de errores en tiempo real en el cliente JS (p. ej. Sentry)",
          "Latencia de API y percentiles de tiempo de respuesta (p95 / p99)",
    ...
    },
    {
      ...
      description:
        "Rastrea la verificación de sesión antes de consultar documentos protegidos.",
      isCodeTracing: true,
      question: {
        questionText:
          "Predice el resultado de autorización después de comprobar autenticación, verificación y propiedad del documento:",
    ...
    },
    {
      ...
      isConversationReview: true,
      description:
        "Celebra cómo tu app creció desde una idea hasta convertirse en un proyecto full-stack conectado y listo para publicar.",
      question: {
        questionText:
          "Tu proyecto alcanzó su hito de publicación. ¡Celebremos todo el recorrido!",
        range: [130, 149],
      },
    },
  ],
